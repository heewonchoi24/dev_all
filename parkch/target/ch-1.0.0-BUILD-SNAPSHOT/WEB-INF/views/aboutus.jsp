                ...
                <div class="container">
                    <div class="row">
                        <div class="main_simple text-center">
                            <div class="col-md-12">
                                <h2>전상희님께서 운영하시는 카페 </h2>
                                <p>매일 업데이트 되는 최신 뉴스를 여기서 확인하세요. </p>
                                <a href="https://story.kakao.com/_gZFMz" class="btn btn-default m-top-40">카카오스토리 바로가기 <i class="fa fa-long-arrow-right"></i></a>
                                </br>
                                <a href="https://band.us/band/76583271" class="btn btn-default m-top-40">박정희와 구미공단 밴드 바로가기 <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active testimonial_item">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            ...
                                            <p class=" m-top-40">Iâve just wordked with Pouseidon last week. Uhm.  
