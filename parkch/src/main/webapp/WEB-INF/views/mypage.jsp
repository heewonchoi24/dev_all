				...
				<div class="content">
					...
					<form action="#" method="post" id="signUpForm" name="signUpForm">
						<div class="field half first">
							...
							<input type="checkbox" id="agree_yn" name="agree_yn" <c:if test="${agreeYn == 'Y'}">checked="true"</c:if>>
						...
						<div class="field half first">
							<label for="u_id" style="text-align: left"><label
								class="req-red">*</label> 아이디 </label> <input
								type="text" name="u_id" id="u_id"
								placeholder="아이디 입력 (4~20자, 한글과 특수문자를 제외한 영문, 숫자)"
								maxLength="20" onkeydown="fnSetId();" value="${userId}" readonly>
						</div>
						<div class="field half first">
						...
						<div class="field half first">
							...
							<td colspan="3"><select id="u_telno1" title="휴대전화 앞 자리(국번)"
								...
								onkeydown="fnSetTelno();" value="${fn:split(userTelno,'-')[1] }"/> - <input type="text"
								name="u_telno3" id="u_telno3" class="tel" style="width: 60px"
								maxLength="4" onkeypress="onlyNumber();"
								onkeydown="fnSetTelno();" value="${fn:split(userTelno,'-')[2] }"/> <input type="hidden"
						...
						<div class="field half first">
							...
							<input type="text" name="u_email" id="u_email"
								placeholder="이메일주소 입력 (ex) parkjh@parkjh.net" maxLength="50" value="${userEmail}">
						...
						<div class="field half first">
							<label for="u_addr"><label class="req-red">*</label> 배송
								...
								readonly type="text" id="u_addr" name="u_addr" value="${userAddr}" />
						</div>
