...
public class Globals {
    ...
    //파일 업로드
	//public static final String CROSSUPLOADER_FILE_PATH	= EgovProperties.getPathProperty("Globals.CrossUploaderFilePath");
    public static final String CROSSUPLOADER_FILE_PATH	= EgovProperties.getProperty("Globals.CrossUploaderFilePath");
    public static final String CROSSUPLOADER_TEMP_PATH	= EgovProperties.getProperty("Globals.CrossUploaderTempPath");
