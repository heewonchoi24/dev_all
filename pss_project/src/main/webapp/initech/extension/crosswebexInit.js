...
var crosswebexInstallPath = crosswebexBaseDir + "/install/install.jsp";
...
function cwShowInstallPage() {
	...
	if (openedWindow == null || openedWindow.closed) {
		openedWindow = window.open(crosswebexInstallPath, "certInstall", "toolbar=no, scrollbars=no, resizable=no, top=200, left=500, width=500, height=370");
...
function cwInstallModuleCallback(result) {
	...
	try {
		...
		if (result && result == "1") {
			...
			//====================================================================================================
			// 정책 설정 - 보안토큰 활성화
			CrossWebExWeb6.SetProperty("certmanui_hsm", "no");
			// 정책 설정 - USIM 활성화
			//CrossWebExWeb6.SetProperty("certmanui_usim", "no");
			// 정책 설정 - USIM - 
			...
			CrossWebExWeb6.SetProperty("certmanui_SelectCertUIMode", "text");
			//====================================================================================================
			// 인증서 OID 필터링
			//====================================================================================================
