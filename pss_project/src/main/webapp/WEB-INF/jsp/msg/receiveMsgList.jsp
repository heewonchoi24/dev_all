...
function fnDeleteMsg(index) {
	...
	if (confirm("삭제하시겠습니까?")) {
		var pUrl = "/msg/deleteReceiveMsg.do";
...
<form method="post" id="form" name="form">
	...
	<input type="hidden" id="typeTR" name="typeTR" value="R">
						...
						<c:when test="${!empty resultList}">
							<c:forEach var="result" items="${resultList}" varStatus="status">
								<tr>
									...
									<td><c:out value="${result.TRNSMIT_NM}"/></td>
									<td class="ta-l">
										<a href="#" onclick="detail_Thread('${result.SEQ}');">${result.SUBJECT}</a>
									</td>
