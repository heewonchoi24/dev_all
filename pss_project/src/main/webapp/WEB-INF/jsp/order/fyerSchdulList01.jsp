...
function goDelete() {
	...
	if (confirm("일정을 삭제 하시겠습니까?")) {
		...
		$.ccmsvc.ajaxSyncRequestPost('/admin/order/deleteFyerSchdul.do', pParam,
	...
	<div id="main">
		<div class="group">
			...
			<div class="header">
				<div class="select">
					년도별 일정&nbsp;&nbsp;&nbsp;&nbsp; 
					<select class="ipt" style="width: 100px;" title="년도 선택" id="orderNo" name="orderNo" onchange="goPage('ML01'); return false;">
			...
			<ul class="tabs">
				<li class="tab active"><a href="#"><span>관리수준 진단</span></a></li>
				<li class="tab"><a href="#" onclick="goPage('ML02'); return false;"><span>관리수준 현황조사</span></a></li>
									...
									<c:forEach var="list" items="${resultList}" varStatus="status">
										<tr>
											...
											<td class="center" style="width: 100px;">
												<a href="#" onclick="goFyerSchdulListView('${list.seq}', '${startFmt}', '${endFmt}', '${fn:replace(list.mngLevelTitle, "'", "\\'") }', '${list.mngLevelCn}');" class="link">수정</a>
											</td>
										</tr>
									</c:forEach>
								</c:when>
