...
function fnDeleteMsg(index) {
	...
	if (confirm("삭제하시겠습니까?")) {
		var pUrl = "/cjs/deleteTrnsmitMsg.do";
...
function detail_Thread(seq){
	...
	document.form.action = "<c:url value='/cjs/trnsmitMsgView.do'/>";
	document.form.submit();	
}
...
<form action="/cjs/trnsmitMsgList.do" method="post" id="form" name="form">
    ...
    <div id="container">
        <div class="content_wrap">
                ...
                <div class="board_search">
                        <fieldset>
                            ...
                            <input type="text" id="label1" class="w40"  maxLength="50"
                             ...
                             >
                            <input type="button" onclick="selectList();" class="button bt3 gray" value="검색" class="button bt3 gray">
                        </fieldset>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <table class="board" summary="전체선택, 번호, 받는사람, 제목, 수신날짜로 구성된 송신업무 리스트입니다.">
                	<caption>송신업무 리스트</caption>
                    <colgroup>
 		                		...
 		                		<c:when test="${!empty resultList}">
				                	<c:forEach var="result" items="${resultList}" varStatus="status">
				                		<tr>
				                			...
				                			<td class="subject"><a href="#" onclick="detail_Thread(&quot;${result.SEQ}&quot;);"><c:out value="${result.SUBJECT}"/></a></td>
