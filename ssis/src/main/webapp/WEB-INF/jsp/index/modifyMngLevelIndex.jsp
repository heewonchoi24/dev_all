...
<script type="text/javascript">
	...
	function onUpdate() {
		...
		var pUrl = "/admin/index/updateMngLevelIndex.do";
		...
		$.ccmsvc.ajaxSyncRequestPost(
			...
			function(data, textStatus, jqXHR) {
				...
				$("#lclas").val("");
				$("#lclasOrder").val("");
				document.indexModifyForm.action = "/admin/index/mngLevelIndexList.do";
	...
	function onDelete() {
		...
		if (confirm("전체 삭제하시겠습니까?")) {
			var pUrl = "/admin/index/deleteMngLevelIndex.do";
									...
									<dl class="index_list depth3">
										...
										<dd>
											...
											<div class="option" class="detailInfo">
												<label for="label5">지표 세부설명</label>
