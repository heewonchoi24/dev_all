...
function goFyerSchdulListView(seq) {
	if('' != seq) {
 		$("#fyerSeq").val(seq);
...
<form method="post" id="fyerSchdulForm" name="fyerSchdulForm">
	...
	<input name="mngLevelCd" id="mngLevelCd" type="hidden" value="ML03"/>
	...
	<div id="main">
		<div class="group">
			...
			<div class="header">
				<div class="select">
					년도별 일정&nbsp;&nbsp;&nbsp;&nbsp; 
					<select class="ipt" style="width: 100px;" title="년도 선택" id="orderNo" name="orderNo" onchange="goPage('ML03'); return false;">
			...
			<ul class="tabs">
				...
				<li class="tab active"><a href="#"><span>서면점검</span></a></li>
			</ul>
			<div class="body">
				<div class="tabCont">
		                    	...
		                    	<c:when test="${!empty resultList}">
		                    		<c:forEach var="list" items="${resultList}" varStatus="status">
				                        <tr>
				                            ...
				                            <td class="center" style="width: 200px;">${list.yyyy}.${list.mm}</td>
											...
											<td class="center" style="width: 100px;"><a href="#" onclick="goFyerSchdulListView('${list.seq}');" class="link">수정</a></td>	                            
				                        </tr>
				                	</c:forEach>
		                        </c:when>
		                        <c:otherwise>
