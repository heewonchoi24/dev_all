...
var headerH ,tabTop, tebFixedSetTime, pc, mobile ;
      ...
      function tabResizeSet(){
          ...
          headerH = (mobileSizeMin < ww) ? 90 : 143;
          tabTop = headerH;
...
function fixedTopMotion(b){
  ...
  if(b){
    ...
    TweenMax.to($("#header .top"),0.2,{"margin-top":-41,onComplete:function(){
      ...
      if(obj == "#popup-brand"){
       ...
       var recentLoad = imagesLoaded($obj);
        recentLoad.off().on( 'always', function(){
         ...
         backgound.stop().animate({"opacity":1},400);
...
;(function($) {
    ...
    $(".onsrSm , .selectBox-dropdown-menu").on("mouseenter mouseleave",function(e){
        if(e.type == "mouseenter"){
             $('body').off("mousewheel");
        }else{
            $.srSmoothscroll({
