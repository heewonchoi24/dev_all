		...
		<div class="sixteen columns offset-by-one">
			<div class="row">
				<div class="one last col">
					...
					<p>
						이 약관은 풀무원건강생활(주)(이하, ‘회사’)가 운영하는 [풀무원건강생활, 풀무원그린체, 녹즙, 베이비밀, 잇슬림]에서 제공하는 인터넷 관련 서비스(이하, ‘서비스’라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
					</p>
					<div class="divider"></div>
