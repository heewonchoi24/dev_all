...
while (rs.next()) {
	...
	if (rcvHp.equals("010-9444-8585") || rcvHp.equals("010-7197-1346")) {
		...
		query1		+= " ) VALUES (";
		query1		+= "	5, now()+"+i+", now(), now(), '"+ rcvHp +"', '02-6411-8322', '[풀무원잇슬림]', '[풀무원잇슬림] 고객님. 금일 상품은 잘 받으셨나요? 풀무원 잇슬림 이용 시 유의 사항 안내드립니다.\rStep 1. 도시락은 꺼내어 되도록 냉장보관 하기 (유통기한 옆면 표시)\rStep 2. 보냉가방과 아이스젤은 그대로 현관문고리에 걸어두기 (아이스젤은 배달시마다 얼린것으로 교체해드려요!)\rStep 3. 배송일 조정은 3일 전까지! (홈페이지 마이잇슬림>배송일조정 또는 1:1게시판을 통해 문의해주세요.) ')";
		try {
