...
<div id="wrap">
	<div class="container" style="margin:0;">
		<div class="sixteen columns offset-by-one" style="margin:0;">
			...
			<div class="row">
				<div class="one last col hideprint">
					...
					<ul class="foodmonthtab floatleft">
						...
						<li<%if (categoryCode.equals("0300965")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0300965">든든한 알라까르떼</a></li>
					</ul>
			...
			<div>
			<div id="intro1"><strong>※ 첫 배송일 선택에 따른 ‘퀴진’ 제품 배송 안내 ※</strong></div>
			<div id="intro2">‘퀴진’제품 주문 시, 첫 배송일 선택에 따라 <strong>주문일로부터 4일차와 5일차에는 ‘구운코코넛오야꼬동’ 메뉴와 ‘느타리버섯불고기세트’ 메뉴가 순차 배송</strong>됩니다.(순서 관계 없음)</br>
				이후 식단은 기존 퀴진 식단 스케줄대로 배송되며, 주문일로부터 <strong>첫 배송일이 6일 후인 경우는, 기존 퀴진 식단 스케줄대로 배송</strong>됩니다.
			</div>
			<div class="clear"></div>
										...
										<td class="fc-day fc-mon fc-widget-content fc-past<%if (newLine == 6) out.println(" fc-last");%>" data-date="<%=nowDate%>">
											<%if (setName.equals("") || setName == null) {%>
												<div>
													...
													<%
														if (bHoliday) { out.print("<strong>"+ arrholidayName[startDay-1] +"</strong>"); }
													%>
													</div>
												</div>
											<%} else {%>
