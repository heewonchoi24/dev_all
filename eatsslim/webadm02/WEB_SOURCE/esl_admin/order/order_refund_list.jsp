...
query		= "SELECT C.ID, O.ORDER_NUM, ifnull((SELECT CH_NAME FROM ESL_CHANNEL WHERE CH_CODE = SHOP_TYPE ), SHOP_TYPE) as SHOPTYPE, ORDER_NAME, O.ORDER_STATE, C.BANK_NAME, C.BANK_ACCOUNT, C.BANK_USER, C.REFUND_PRICE,";
query		+= "	C.PG_CANCEL";
		...
		<div id="incon">
			...
			<div id="contents">
					...
					<table class="table02" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<th scope="col"><span>주문채널</span></th>
							...
							<tr>
								<td>
								<input type="checkbox" class="selectable" value="<%=refundId%>"  <% if (refundYn.equals("Y")) {%>disabled <% } %>/>
								</td>
								<td><%=curNum%></td>
								<td><%=orderName%></td>
				...
				<div class="btn_style1">
					<p class="left_btn">
						<a href="javascript:;" onclick="refundAll();" class="function_btn"><span>환불</span></a>						
					</p>
				</div>
				<div class="btn_style1">
					<p class="right_btn">
