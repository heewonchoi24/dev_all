...
where			= " WHERE O.ORDER_NUM = C.ORDER_NUM AND O.ORDER_STATE IN (90,901,91,911)";
...
<%@ include file="../include/inc-cal-script.jsp" %>
	...
	$(function(){
		...
		$('#lnb').menuModel2({hightLight:{level_1:2,level_2:1,level_3:0},target_obj:'',showOps:{display:'block'}, hideOps:{display:'block'}});
		leftcon();
	})
	//]]>
	</script>
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="location">
				...
				<p id="path"><img src="../images/common/layout/ico_home.gif" alt="홈" /> &gt; 주문관리 &gt; 취소/반품관리 &gt; <strong>취소관리</strong></p>
			</div>
			<!-- //location -->
			<!-- contents -->
			<div id="contents">
					...
					<table class="table02" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<th scope="col"><span>취소요청일</span></th>
								<th scope="col"><span>승인일</span></th>
								<th scope="col"><span>취소사유</span></th>
							</tr>
							<%
							if (intTotalCnt > 0) {
								while (rs.next()) {
							...
							%>
							<tr>
								<td colspan="10">등록된 취소내역이 없습니다.</td>
							</tr>
							<%
							}
							%>
