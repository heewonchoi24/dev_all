		...
		<!-------------------------------------->
			<div class="tab_layout" style="display:block;" id="tablmenu1">
				...
				<form name="frm_devl" id="frm_devl">
					...
					<input type="hidden" name="sub_num" id="sub_num" value="<%=subNum%>" />
					<div class="btn_style1">
					- 퀴진 주문은 패턴적용 또는 일괄변경 이용 시 주문조정일 기준으로 4일, 5일 제품은 퀵메뉴(잇슬림_B)로 변경되니 개별조정 이용바랍니다.
						<p class="right_btn">
							...
							<tr>
								...
								<td>
									<select name="gubun_code">
										...
										<option value="0300717">퀴진</option>
										<option value="0300957">알라까르떼 헬씨</option>
										<option value="0300719">알라까르떼 슬림</option>
										<option value="0301369">헬씨퀴진</option>
										<option value="0070817">자몽&마테 발효녹즙</option>
										<option value="0301584">미니밀(권재연)</option>
									</select>
								</td>
