						...
						<tbody>
							<tr>
								...
								<td class="td01">
									...
									<a href="#" onclick="window.open('/shop/popup/AddressSearchJiPop.jsp?ztype=0001','chk_zipcode','width=800,height=650,top=50,left=100,scrollbars=yes,resizable=no,toolbar=no,status=no,menubar=no');" class="function_btn"><span>우편번호 검색</span></a>
									<p class="mt_5">
