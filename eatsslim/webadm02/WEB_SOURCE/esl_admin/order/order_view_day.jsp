...
query        += "    ORDER_NAME, SHOP_TYPE, OUT_ORDER_NUM, OG.COUPON_NUM, OG.DEVL_TYPE";
        ...
        <!-------------------------------------->
            <div class="tab_layout" style="display:block;" id="tablmenu1">
                ...
                <form name="frm_devl" id="frm_devl">
                    ...
                    <input type="hidden" name="sub_num" id="sub_num" value="<%=subNum%>" />
                    <div class="btn_style1">
                    - 400 슬림식 주문은 패턴적용 또는 일괄변경 이용 시 주문조정일 기준으로 4일, 5일 제품은 퀵메뉴(잇슬림_B)로 변경되니 개별조정 이용바랍니다.
                        <p class="right_btn">
                        ...
                        <tbody>
                            ...
                            if (tcnt > 0) {
                                ...
                                while (rs.next()) {
									...
									query4        = "  SELECT SET_CODE FROM  ESL_GOODS_SET where CATEGORY_ID = 19 ";
									try {
									...
									while(rs4.next()){
										pSetCodes         = rs4.getString("SET_CODE");

										if( groupCode.equals(pSetCodes)){    // 150 프로틴밀
											query2        = " SELECT SET_NAME FROM ESL_GOODS_SET WHERE SET_CODE = '" + groupCode +"' ";
											...
											if(rs2.next()){
												prdtSetName        = rs2.getString("SET_NAME");
											}
											rs2.close();
                            ...
                            <tr>
                                <td>
                                    <select name="group_code" id="group_code" >
                                        ...
                                        if (rs.next()) {
                                            pGroupCode = rs.getString("GROUP_CODE");

                                            if(pGroupCode.equals("0301844")){    // 150 프로틴밀

                                                query1        = " SELECT SET_CODE, SET_NAME FROM ESL_GOODS_SET WHERE CATEGORY_ID = 19 ";
                                                try {
                                                    rs1    = stmt.executeQuery(query1);
                                                } catch(Exception e) {
                                                    out.println(e+"=>"+query1);
                                                ...
                                                while(rs1.next()){
                                                    %>
                                                    <option id="p_set_code" value="<%=rs1.getString("SET_CODE")%>"><%=rs1.getString("SET_NAME")%></option>
                                                    <%                                        
                                                }
                                ...
                                <td>
                                    <input type="text" name="order_cnt" id="order_cnt" value="1" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');" dir="rtl" style="width:40px;" maxlength="3" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="gubun_code">
                                        <option value="<%=gubunCode%>">주문제품</option>
                                        <option value="0300717">400 슬림식</option>
                                        <option value="0300957">300 덮밥</option>
                                        <option value="0300719">300 샐러드</option>
                                        <option value="0301369">500 차림</option>
                                        <option value="0070817">자몽&마테 발효녹즙</option>
                                        <option value="0301544">200 스팀샐러드</option>
                                    </select>
                                </td>
                                ...
                                <td><input type="text" name="order_cnt" id="order_cnt" value="1" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');" dir="rtl" style="width:40px;" maxlength="3" /></td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="td01">
                                    ...
                                    <% } else { %>
                                    <a href="javascript:;" onclick="window.open('/shop/popup/AddressSearchJiPop.jsp?ztype=0002','chk_zipcode','width=800,height=650,top=50,left=100,scrollbars=yes,resizable=no,toolbar=no,status=no,menubar=no');" class="function_btn"><span>우편번호 검색</span></a>
                                    <% } %>
                                    <p class="mt_5">
                                        ...
                                        <input type="hidden" id="rcv_addr_bcode" name="rcv_addr_bcode" value="" />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table class="table01 mt_5" border="1" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><span>배달점</span></th>
                                <td class="td01">
									<input type="text" class="input1" name="agcycode" id="agcycode" maxlength="8" style="width:60px" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');" value="" />
