...
String useYn			= ut.inject(multi.getParameter("use_yn"));
...
if (mode != null) {
	...
	if (mode.equals("ins")) {
		...
		try {
			...
			query		+= "	(CATEGORY_ID, SET_CODE, SET_NAME, SET_PRICE, SET_INFO, MAKE_DATE, THUMB_IMG, BIG_IMG,";
			query		+= "	BIGO, USE_YN, INST_ID, INST_IP, INST_DATE)";
			query		+= " VALUES";
			query		+= "	(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
