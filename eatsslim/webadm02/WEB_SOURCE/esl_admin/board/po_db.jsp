	...
	if (mode.equals("ins")) {
		try {
			if(instDate.equals("")){
				...
				query		+= "	(TITLE, CONTENT, LIST_IMG, PRESS_URL, HIT_CNT, INST_ID, INST_IP, INST_DATE,best_set)";
				query		+= " VALUES";
				query		+= "	(?, ?, ?, ?, 0, ?, ?, NOW(),?)";
		...
		ut.jsRedirect(out, "po_list.jsp?"+ param);
