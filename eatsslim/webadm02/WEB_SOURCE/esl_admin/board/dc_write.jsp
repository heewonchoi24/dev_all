...
<div id="wrap">
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<!-- contents -->
			<div id="contents">
				<form name="frm_write" id="frm_write" method="post" action="dc_db.jsp" enctype="multipart/form-data">
							...
							<tr>
								...
								<td>
									<select name="press_url" id="press_url">
										<option value="1">다이어트 먹거리</option>
										<option value="2">다이어트 생활습관</option>
										<option value="3">다이어트 속설과 과학</option>
										<option value="4">비교 잇슬림</option>
									</select>
								</td>
							</tr>
					...
					<div class="btn_center">
						...
						<a href="dc_list.jsp" class="function_btn"><span>목록</span></a>
					</div>
				</form>
			</div>
			<!-- //contents -->
