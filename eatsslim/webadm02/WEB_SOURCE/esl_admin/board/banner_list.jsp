								...
								<td>
									<span>
										<select style="width:80px;" name="banner_type" onchange="this.form.keyword.focus()">
											...
											<option value="2"<%if(bannerType.equals("2")){out.print(" selected=\"selected\"");}%>>추천배너</option>
											<option value="3"<%if(bannerType.equals("3")){out.print(" selected=\"selected\"");}%>>GNB배너</option>
