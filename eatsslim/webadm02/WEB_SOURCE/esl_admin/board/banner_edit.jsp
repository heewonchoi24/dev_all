							...
							<tr>
								...
								<td>
									<select name="banner_type" id="banner_type" required label="구분">
										...
										<option value="2"<%if (bannerType.equals("2")) out.println(" selected=\"selected\"");%>>추천배너</option>
										<option value="3"<%if (bannerType.equals("3")) out.println(" selected=\"selected\"");%>>GNB배너</option>
