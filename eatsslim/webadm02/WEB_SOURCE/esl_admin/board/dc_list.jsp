...
query		= "SELECT ID, TITLE, HIT_CNT, DATE_FORMAT(INST_DATE, '%Y.%m.%d') WDATE,PRESS_URL,(select count(id) from ESL_DC_REPLY where ID="+table+".ID) as re_cnt";
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="contents">
				...
				<form name="frm_list" id="frm_list" method="post" action="dc_db.jsp" enctype="multipart/form-data">
					...
					<table class="table02" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td><%=instDate%></td>
								<td>
									<a href="dc_edit.jsp?id=<%=pressId + param%>" class="function_btn"><span>수정</span></a>
								</td>
							</tr>
							<%
									curNum--;
				...
				<div class="btn_style1">
					...
					<p class="right_btn">
						<a href="dc_write.jsp" class="function_btn"><span>등록</span></a>
					</p>
				</div>
