...
function mini_command(idx,str,value)
{
	...
	switch (str){
		...
		case "InsertTable":
			...
			return; break;
		case "InsertImage":
			window.open(mini_path + "popup.image.jsp?code=goods_desc&idx=" + idx,"","width=400,height=310");
			return; break;
	}
...
function miniEditorFrame(obj,idx)
{
	...
	<head>\
		...
		<style>body {margin:10px;} body,table {font:x-small µ¸¿ò} p {margin:2px 0}</style>\
	</head>\
	";
