...
var easyConfig = {
	...
	BtnList : {
		...
		underline : ["¹ØÁÙ","underline.gif"], about : ["","about.gif"],
...
var easyUtil = {	
	...
	{	
		...
		var s="<span style='color:#ff6600'>easyWebEditor</span><br/>version "+easyConfig.version+"";		
...
easyConfig.BtnList.upload_image = ["ÀÌ¹ÌÁö ¾÷·Îµå","image.gif",
function (self){
 window.open(easyConfig.filepath+"/upload_image.php","image","width=300,height=390,status=1");
}];
