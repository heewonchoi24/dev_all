							...
							<tr>
								...
								<td>
									<select name="sch_gubun1" id="sch_gubun1" onchange="getGubun2()">
										...
										<option value="50"<%if (schGubun1.equals("50")) { out.println(" selected=\"selected\"");}%>>기능식품</option>
										<option value="60"<%if (schGubun1.equals("60")) { out.println(" selected=\"selected\"");}%>>건강즙</option>
									</select>
									<select name="sch_gubun2" id="sch_gubun2">
										...
										%>
										<option value="31"<%if (schGubun2.equals("31")) { out.println(" selected=\"selected\"");}%>>시크릿수프</option>
										<option value="32"<%if (schGubun2.equals("32")) { out.println(" selected=\"selected\"");}%>>밸런스쉐이크</option>
										<%
											} else if (schGubun1.equals("50")) {
										%>
										<option value="01"<%if (schGubun2.equals("01")) { out.println(" selected=\"selected\"");}%>>유산균</option>
										<option value="02"<%if (schGubun2.equals("02")) { out.println(" selected=\"selected\"");}%>>비타민</option>
										<option value="03"<%if (schGubun2.equals("03")) { out.println(" selected=\"selected\"");}%>>식사대용</option>
										<option value="04"<%if (schGubun2.equals("04")) { out.println(" selected=\"selected\"");}%>>기타</option>
										<%
											}
										} else {
										%>
							...
							if (intTotalCnt > 0) {
								while (rs.next()) {
									...
									if (gubun1.equals("01")) {
										...
										editUrl		= "goods_group_fvt_edit.jsp";
									} else if (gubun1.equals("60")) {
										editUrl		= "goods_group_hz_edit.jsp";
									}
							%>
							<tr>
				...
				<div class="btn_style1">
					...
					<p class="right_btn">
						<select name="sel_group" id="sel_group">
							...
							<option value="fvt"<%if (schGubun1.equals("50")) { out.println(" selected=\"selected\"");}%>>기능식품</option>
							<option value="hz"<%if (schGubun1.equals("60")) { out.println(" selected=\"selected\"");}%>>건강즙</option>
						</select>
