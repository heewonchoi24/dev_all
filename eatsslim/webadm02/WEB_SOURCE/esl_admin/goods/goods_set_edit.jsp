					...
					<table class="tableView" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="text" class="input1" style="width:200px;" maxlength="50" name="set_name" id="set_name" value="<%=setName%>" required label="메뉴명" readonly="readonly" />
								</td>
							...
							<tr>
								...
								<td>
									<select name="cate_code" required label="카테고리">
										...
										%>
										<option value="<%=cateId%>"<%if (cateId == categoryId) out.println(" selected=\"selected\"");%>><%=cateName+"("+rs.getString("CATE_CODE")+")"%></option>
										<%
										}
										%>
									</select>
							...
							<tr>
								...
								<td colspan="3" class="td_edit">
									<input type="radio" name="use_yn" id="use_yn1" value="Y"<%if (useYn.equals("Y")) out.println(" checked=\"checked\"");%> />
									<label for="use_yn1">사용</label>
									<input type="radio" name="use_yn" id="use_yn2" value="N"<%if (useYn.equals("N")) out.println(" checked=\"checked\"");%> />
