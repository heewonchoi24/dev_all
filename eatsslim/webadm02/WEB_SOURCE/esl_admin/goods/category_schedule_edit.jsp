					...
					<table class="tableView calendar_input" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								<td>
								&nbsp;&nbsp;일괄변경&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" name="r_stdate" id="r_stdate" class="input1" maxlength="10" readonly="readonly" value="" / placeholder="반복패턴 시작일">
									~
									<input type="text" name="r_ltdate" id="r_ltdate" class="input1" maxlength="10" readonly="readonly" value="" / placeholder="반복패턴 종료일">
									&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;
									<input type="text" name="mr_stdate" id="mr_stdate" class="input1" maxlength="10" readonly="readonly" value="" / placeholder="적용일자 시작일">
									~
									<input type="text" name="mr_ltdate" id="mr_ltdate" class="input1" maxlength="10" readonly="readonly" value="" / placeholder="적용일자 종료일">
								</td>
								<td class="td_center">
