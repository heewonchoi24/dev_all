...
if (mode != null) {
	...
	if (mode.equals("ins")) {
		...
		query		+= "	(EVENT_TYPE, TITLE, STDATE, LTDATE, OPEN_YN, EVENT_TARGET, ANC_DATE, CONTENT, LIST_IMG,";
		...
		pstmt.setString(9, listImg);
		pstmt.setString(10, eventUrl);
		pstmt.setString(11, instId);
		pstmt.setString(12, userIp);
		pstmt.setString(13, viewImg);
		pstmt.setString(14, gubun);
		pstmt.executeUpdate();
		try {
