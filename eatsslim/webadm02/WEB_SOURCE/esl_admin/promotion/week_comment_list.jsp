...
query		= "SELECT ID, STDATE, LTDATE, TITLE, DATE_FORMAT(INST_DATE, '%Y.%m.%d') INST_DATE";
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="contents">
				...
				<form name="frm_list" id="frm_list" method="post" action="week_comment_db.jsp">
					...
					<table class="table02" border="1" cellspacing="0">
						...
						<tbody>
							...
							%>
							<tr>
								<td><input type="checkbox" class="selectable" value="<%=weekId%>" /></td>
								<td><%=curNum%></td>
								<td><%=stdate +"~"+ ltdate%></td>
								<td><%=title%></td>
								<td><%=instDate%></td>
								<td>
									<a href="week_comment_edit.jsp?id=<%=weekId + param%>" class="function_btn"><span>수정</span></a>
								</td>
							</tr>
							<%
									curNum--;
							...
							%>
							<tr>
								<td colspan="6">등록된 전문가 주간 코멘트가 없습니다.</td>
							</tr>
							<%
							}
							%>
				...
				<div class="btn_style1">
					...
					<p class="right_btn">
						<a href="week_comment_write.jsp" class="function_btn"><span>등록</span></a>
					</p>
				</div>
