	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="location">
				...
				<p id="path"><img src="../images/common/layout/ico_home.gif" alt="홈" /> &gt; 이벤트 &gt; <strong>밀착감시</strong></p>
			</div>
			<!-- //location -->
			<!-- contents -->
			<div id="contents">
				<form name="frm_edit" id="frm_edit" method="post" action="event_observe_db.jsp" enctype="multipart/form-data">
					...
					<div class="btn_center">
						...
						<a href="event_observe.jsp?<%=param%>" class="function_btn"><span>목록</span></a>
					</div>
				</form>
				...
				<script>
					function reply_del(idx){
						...
						if(confirm("삭제하시겠습니까?")){
							...
							f.action="event_observe_edit_reply_db.jsp";
							f.submit();
						}
					}
				...
				<%
					//댓글수
					query		= "SELECT COUNT(ID) FROM ESL_EVENT_OBSERVE_REPLY where ID="+pressId+"";
					...
					<p>댓글수(<%=reply_count%>)</p>
							...
							<ul style="padding-top:10px">
							    <li class="comment depth-1" >
									...
									<%
									query		= "SELECT * ";
									query		+= " FROM ESL_EVENT_OBSERVE_REPLY where ID="+pressId+"";
