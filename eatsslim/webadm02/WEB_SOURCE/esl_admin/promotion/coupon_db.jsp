...
String delIds			= "";
//String upfile			= ut.inject(multi.getParameter("upfile"));
String upfile			= "";
...
String[] orderWeek	= multi.getParameterValues("order_week");	// 주문기간
String orderWeeks = "";	

if(orderWeek != null){
	for(int k = 0; k<orderWeek.length; k++){
		orderWeeks += orderWeek[k];
		orderWeeks += ",";	
	}
}
...
if (mode != null) {
	...
	if (mode.equals("ins")) {
		...
		try {		
			...
			pstmt.setString(4, ltdate);
			//pstmt.setString(5, vendor);
			pstmt.setString(5, saleType);
			pstmt.setInt(6, salePrice);
			pstmt.setString(7, saleUseYn);
			pstmt.setInt(8, useLimitCnt);
			pstmt.setInt(9, useLimitPrice);
			pstmt.setString(10, useGoods);
			pstmt.setInt(11, maxCoponCnt);
			pstmt.setString(12, instId);
			pstmt.setString(13, userIp);
			pstmt.setString(14, randNumType);
			pstmt.setString(15, orderWeeks);
