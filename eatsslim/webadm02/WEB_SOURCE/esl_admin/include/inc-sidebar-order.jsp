<%@ page language="java" contentType="text/html; charset=EUC-KR" pageEncoding="EUC-KR"%>
		...
		<div id="sidebar">
			...
			<ul id="lnb">
				...
				<li><a href="order_write.jsp">관리자 주문등록</a></li>
				<li><a href="outmall_upload.jsp">외부몰업로드</a></li>
				<li><a href="order_excel_list.jsp">주문/출고실적 조회</a></li>
				<li><a href="group_order_list.jsp">단체주문관리</a></li>
				<li><a href="order_check_list.jsp">배달점확인리스트</a></li>
			</ul>
			<!-- //lnb -->
			<%}else{
