		...
		<ul id="dropline">
			<li class="top<%if (request.getRequestURI().indexOf("/shop") >= 0 && request.getRequestURI().indexOf("/shop/mypage") < 0) out.print(" current");%>"><a class="down" href="/shop/orderGuide.jsp"><span class="m01"></span>SHOP</a>
				<ul class="sub">
					...
					<li<%if (request.getRequestURI().indexOf("/shop/reductionProgram") >= 0 || request.getRequestURI().indexOf("/shop/keepProgram") >= 0 || request.getRequestURI().indexOf("/shop/fullstepProgram") >= 0) out.print(" class=\"current\"");%>><a href="/shop/fullstepProgram.jsp">프로그램 다이어트</a>
						<ul class="sub">
							<li<%if (request.getRequestURI().indexOf("/shop/fullstepProgram") >= 0) out.print(" class=\"current\"");%>><a href="/shop/secretSlimming.jsp">시크릿 슬리밍</a></li>
							<li<%if (request.getRequestURI().indexOf("/shop/fullstepProgram") >= 0) out.print(" class=\"current\"");%>><a href="/shop/weight2weeks.jsp">집중감량2주</a></li>
							<li<%if (request.getRequestURI().indexOf("/shop/fullstepProgram") >= 0) out.print(" class=\"current\"");%>><a href="/shop/fullstepProgram.jsp">NEW FULL-STEP 프로그램</a></li>
						</ul>
					</li>
					<li<%if (request.getRequestURI().indexOf("/shop/secretSoup") >= 0) out.print(" class=\"current\"");%>><a href="/shop/minimeal.jsp">간편식</a>
