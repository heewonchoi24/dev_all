...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>프로그램 다이어트</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>6일간의 시크릿 슬리밍</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">6일간의 시크릿 슬리밍</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head" style="padding:25px 0;">
							<p class="f18 bold8">초단기간 집중감량을 원하는 고객을 위한</p>
							<p class="f24 bold8">6일간의 시크릿 슬리밍</p>
						</div>
						<div style="margin:20px auto 0;">
							...
							<img src="/images/secretSlimming_pr.jpg" width="640" height="360" alt="6일간의 시크릿 슬리밍">
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<form name="frm_order" id="frm_order" method="post">
			...
			<div class="sidebar five columns">
				...
				<div class="sideorder">
					<div class="title">주문 STEP (일괄 택배 배송)</div>
					<div class="itembox">
						<ul class="badgecount">
							<li>
							...
							<li>
								...
								-->
								<br /><font style="font-weight:normal; color:#777;">6일(한번에 택배 일괄 배송)</font></p>
							</li>
							<li>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p class="marb40"><img src="/images/detail_detox.jpg" alt="상세정보"></p>
