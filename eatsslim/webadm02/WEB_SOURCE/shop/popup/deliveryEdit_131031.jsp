					...
					<div class="one last col">
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<th>배송지 주소</th>
								<td colspan="3">
									<input name="rcv_zipcode1" id="rcv_zipcode1" type="text" class="ftfd" style="width:50px;" value="<%=rcvZipcode1%>" required label="우편번호" readonly="readonly" maxlength="3" />
									-
                                    <input name="rcv_zipcode2" id="rcv_zipcode2" type="text" class="ftfd" style="width:50px;" value="<%=rcvZipcode2%>" required label="우편번호" readonly="readonly" maxlength="3" />
									<span class="button light small"><a href="#" onclick="window.open('/esl_admin/include/inc-popup-zipcode1.jsp','popup','width=450,height=370,resizable=no,scrollbars=yes');">우편번호 검색</a></span>
									<br />
					...
					<div class="one last col">
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<th>배송지 주소</th>
								<td colspan="3">
									<input name="tag_zipcode1" id="tag_zipcode1" type="text" class="ftfd" style="width:50px;" value="<%=tagZipcode1%>" required label="우편번호" readonly="readonly" maxlength="3" />
									-
                                    <input name="tag_zipcode2" id="tag_zipcode2" type="text" class="ftfd" style="width:50px;" value="<%=tagZipcode2%>" required label="우편번호" readonly="readonly" maxlength="3" />
									<span class="button light small"><a href="#" onclick="window.open('/esl_admin/include/inc-popup-zipcode2.jsp','popup','width=450,height=370,resizable=no,scrollbars=yes');">우편번호 검색</a></span>
									<br />
...
function recentAddr(str) {
	if (str == 'n') {
		...
		if (f.rcv_name) {
			...
			f.tag_zipcode1.value	= "<%=tagZipcode1%>";
			f.tag_zipcode2.value	= "<%=tagZipcode2%>";
