    ...
    <div class="popup columns offset-by-one">
      <div class="row">
        <div class="one last col">
          ...
          <div class="matchfood"> <img class="thumbleft" src="/images/result_keepProgram.jpg" width="130" height="80"> <span class="post-title">
            <h4>2주 유지프로그램</h4>
            <p>감량 후 요요현상이 우려되는 고객을 위하여 일반식사로의 적응을 단계적으로 도와주고 식사의 protion control을 트레이닝할 수 있는 칼로리 Down, 나트륨 Down 식습관 셋업 맞춤형 프로그램입니다.</p>
            </span> </div>
          <div class="clear"></div>
        </div>
      </div>
