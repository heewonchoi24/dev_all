...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>프로그램 다이어트</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>감량&유지 4주</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">감량&유지 4주</h3>
		...
		<form name="frm_order" id="frm_order" method="post">
			...
			<input type="hidden" name="gubun2" id="gubun2" value="24" />
						...
						<ul class="badgecount">
							...
							<li>
								...
								<div class="ordernum">
									...
									<br /><font style="font-weight:normal; color:#777;">4주(주말 제외, 평일 20일동안 매일 배송)</font></p>
									<div class="clear"></div>
							</li>
							<li>
