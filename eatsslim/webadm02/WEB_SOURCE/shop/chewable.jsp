...
query		= "SELECT ID, GROUP_NAME, GROUP_PRICE, GROUP_INFO, OFFER_NOTICE, GROUP_CODE FROM ESL_GOODS_GROUP WHERE GUBUN1 = '50' AND GUBUN2 = '02' AND  GROUP_CODE = '0301316' ";
...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>풀비타</h1>
			<div class="pageDepth">
				HOME > SHOP > 풀비타 > <strong>베리뷰티츄어블C</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">베리뷰티츄어블C</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head">
							<p class="f18 bold8">뷰티베리 함유 식물성 천연 원료 비타민!</p>
							<p class="f24 bold8">베리뷰티츄어블C</p>
						</div>
						<div class="center">
                          <p class="mart20"><img src="/images/chewable.jpg" width="638" height="180" /></p>
                        </div>
						<div class="clear"></div>
					</div>
				</div>
