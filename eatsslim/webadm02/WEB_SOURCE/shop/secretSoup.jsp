...
if (rs.next()) {
	...
	totalPrice		= price * 5 + defaultBagPrice;
	//tSalePrice		= (int)Math.round((double)(price * 5) * (double)(100 - 10) / 100) + defaultBagPrice;
...
function getSalePrice() {
	...
	if (parseInt(salePrice) > 0 && saleType) {
		...
		if (saleType == "W") {
			if ( $("#ss_type").val() == "0" ) {
				salePrice	= (totalPrice - bagPrice) - salePrice * parseInt($("#devl_week").val()) * 5 * buyQty + bagPrice;
			} else { 
