...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>프로그램 다이어트</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>스피드 4주</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">스피드 4주</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head" style="padding:25px 0;">
							<p class="f18 bold8">바쁜 현대인들을 위한 1일 2식 제공으로 맛있고, 간편하게 감량 효과를 경험할 수 있는</p>
							<p class="f24 bold8"> 잇슬림 스피드 4주 프로그램</p>
						</div>
						<div style="margin:20px auto 0;">
							<p class="marb9">퀴진, 알라까르떼로 구성된 잇슬림 스피드 4주 프로그램! <br/><strong>점심엔 퀴진, 저녁엔 알라까르떼 헬씨</strong>로 감량 효과를 볼 수 있는 프로그램입니다. </p>
							<img src="/images/speed4weeks_detail01.png" width="640" height="360" alt="집중감량 프로그램(2주)">
							<p class="marb9">* 잇슬림 스피드 4주 프로그램은 풀무원건강생활에서 판매되는 <strong>'그린체 에스플랜'</strong>  제품과 함께 섭취하시면 체중 감량조절에 효과적입니다.</p>
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p><img src="/images/speed4weeks_detail02.jpg"></p>
						<!-- <%=groupInfo%> -->
					</div>
					<div class="divider"></div> 
					<ul class="tabNavi marb30">
					...
					<div id="detail-delivery">
						<p><img src="/images/speed4weeks_detail03.jpg"></p>
						<!-- <%=offerNotice%>  -->
					</div>
					<div class="divider"></div>
					<ul class="tabNavi marb30">
                    ...
                    <table class="orderList clear" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>식품의 유형</td>
							<td style="text-align:left;"><span class="font-blue">알라까르떼, 퀴진 : </span>즉석섭취식품</td>
						</tr>
						<tr>
						  <td>제조원 및 생산자</td>
