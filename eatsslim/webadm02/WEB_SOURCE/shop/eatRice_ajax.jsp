...
int buyQty3			= 0;
if (request.getParameter("buy_qty3") != null && request.getParameter("buy_qty3").length()>0) {
	buyQty3		= Integer.parseInt(request.getParameter("buy_qty3"));
}
int buyQty4			= 0;
if (request.getParameter("buy_qty4") != null && request.getParameter("buy_qty4").length()>0) {
	buyQty4		= Integer.parseInt(request.getParameter("buy_qty4"));
}
