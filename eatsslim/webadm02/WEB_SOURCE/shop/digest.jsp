...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>풀비타</h1>
			<div class="pageDepth">
				HOME > SHOP > 풀비타 > <strong>다이제스트</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">다이제스트</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head">
							<p class="f18 bold8">내 몸에 딱 맞는 복합 소화효소!</p>
							<p class="f24 bold8">다이제스트</p>
						</div>
						<div class="center">
                          <p class="mart20"><img src="/images/digest.jpg" width="638" height="180" /></p>
                        </div>
						<div class="clear"></div>
					</div>
				</div>
