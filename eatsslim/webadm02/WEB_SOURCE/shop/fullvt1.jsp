...
query		= "SELECT ID, GROUP_NAME, GROUP_PRICE, GROUP_INFO, OFFER_NOTICE, GROUP_CODE FROM ESL_GOODS_GROUP WHERE GUBUN1 = '03' AND GUBUN2 = '32'";
...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>풀비타</h1>
			<div class="pageDepth">
				HOME > SHOP > 풀비타 > <strong>밸런스 쉐이크</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">다이어트 CLA</h3>
				<div class="twothird last col">
				

                          <p class="mart20"><img src="/images/diet_cal.jpg" width="638" height="207" /></p>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p class="marb40"><img src="/images/diet_cal_detail.jpg" alt="상세정보"></p>
