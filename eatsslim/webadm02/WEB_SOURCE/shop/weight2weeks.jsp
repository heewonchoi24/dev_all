...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>프로그램 다이어트</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>집중감량 2주</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">집중감량 2주</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head" style="padding:25px 0;">
							<p class="f18 bold8">단기간 감량을 원하는 고객을 위한</p>
							<p class="f24 bold8"> 집중감량 2주</p>
						</div>
						<div style="margin:20px auto 0;">
							...
							<img src="/images/2weeks_pr.png" width="640" height="360" alt="집중감량 프로그램(2주)">
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p><img src="/images/detail_2weeks-program.jpg"></p>
						<!-- <%=groupInfo%> -->
					</div>
					<div class="divider"></div> 
					<ul class="tabNavi marb30">
