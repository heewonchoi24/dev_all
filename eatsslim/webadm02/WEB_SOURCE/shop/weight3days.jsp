...
String where			= " WHERE GUBUN1 = '02' AND GUBUN2 = '26'";
...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>프로그램 다이어트</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>3일 프로그램</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">3일 프로그램</h3>
				<img src="/images/promotion/event_150713/3days_pr.jpg" width="682" height="611" alt="잇슬림 3일 체험 상품">
			</div>
		</div>
		...
		<form name="frm_order" id="frm_order" method="post">
			...
			<input type="hidden" name="gubun2" id="gubun2" value="26" />
			<input type="hidden" name="gubun3" id="gubun3" value="1" />
				...
				<div class="sideorder">
					...
					<div class="itembox">
						...
						<!--		</p><div class="ordernum">
									...
									<br/><font style="font-weight:normal; color:#777;">3일(주말 제외, 평일 3일동안 매일 배송)</font></p>
									<div class="clear"></div>
							...
							<!--li>
								...
								<input type="hidden" name="devl_day" id="devl_day"  value="3" />
						</ul>
					</div>
				</div>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p><img src="/images/promotion/event_150713/detail_3days-program.jpg"></p>
						<!-- <%=groupInfo%> -->
					</div>
					<div class="divider"></div> 
					<ul class="tabNavi marb30">
...
function addCart(t) {
	$("#cart_type").val(t);
	$.post("keepPromotion_ajax.jsp", $("#frm_order").serialize(),
	function(data) {
		$(data).find("result").each(function() {
			if (!$("#set_holiday").val() && $(this).text() == 'setHoliday') {
				window.open("popup/deliveryDate.jsp?devl_date="+ $("#devl_date").val() +"&devl_day=3&devl_week="+ $("#gubun3").val() +"&gid="+ $("#group_id").val(),'popDelivery','resizable=no,scrollbars=yes,toolbar=no,location=no,status=no,menubar=no,width=960,height=500');
