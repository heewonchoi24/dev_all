...
query		= "SELECT ID, GROUP_NAME, GROUP_PRICE, GROUP_INFO, OFFER_NOTICE, GROUP_CODE FROM ESL_GOODS_GROUP WHERE GUBUN1 = '50' AND GUBUN2 = '04' AND GROUP_CODE = '0130144' ";
...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>풀비타</h1>
			<div class="pageDepth">
				HOME > SHOP > 풀비타 > <strong>다이어트 CLA</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="eleven columns offset-by-one ">
			<div class="row">
				<h3 class="marb20">다이어트CLA</h3>
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head">
							<p class="f18 bold8">장 건강과 정상적인 면역 기능을 위하여!</p>
							<p class="f24 bold8">다이어트 CLA</p>
						</div>
						<div class="center">
                          <p class="mart20"><img src="/images/dietCLA.jpg" width="638" height="180" /></p>
                        </div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<form name="frm_order" id="frm_order" method="post">
			...
			<div class="sidebar five columns">
				...
				<div class="price-wrapper">
					<!--font style="font-weight:bold; color:blue;">다이어트 CLA 1+1 이벤트! (~2/13)</font-->
