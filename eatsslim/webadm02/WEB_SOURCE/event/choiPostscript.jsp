            ...
            <div class="row">
                <div class="one last  col">
                    <div class="graytitbox">
						...
						<%	} else {	%>
							<a href="javascript:;" onclick="window.open('/event/choiPostscriptWrite.jsp','PostWrite','width=1024,height=600,scrollbars=1')">체험후기 작성</a>
						<%	} %>
						</div>
                    </div>
                </div>
			    ...
			    <div class="one last col">
				   <div class="fluidbox best">
					...
					<div class="box<%=divClass%>">
                        <div class="article">
                              <a href="/event/choiPostscriptView.jsp?id=<%=postId + param%>">
                              	  <% if(imgUrl !=""){ %>
                ...
                <div class="one last  col">
                    <div class="graytitbox">
                        <ul class="filter floatleft" style="margin-top:5px;">
                            <li <% if(p_gubun.equals("")){ %> class="current" <% } %>><a href="choiPostscript.jsp">ALL(<%=gubun_all_cnt%>)</a></li>
