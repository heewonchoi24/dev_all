				...
				<div class="one last col center">
					<div class="archive-title">
						...
						<div class="archive-pagenavi">
							<%
							query		= "SELECT ID, TITLE FROM "+ table +" WHERE ID < ? AND VERSUS = '2' ORDER BY ID DESC LIMIT 0, 1";
							pstmt		= conn.prepareStatement(query);
							pstmt.setInt(1, diaryId);
							rs			= pstmt.executeQuery();
							...
							if (rs.next()) {
							%>
							<a class="prev" href="lee_diary.jsp?id=<%=rs.getInt("ID")%>">&lt;&lt;</a>
							<%} else {%>
							...
							query		= "SELECT ID, TITLE FROM "+ table +" WHERE ID > ? AND VERSUS = '2' ORDER BY ID ASC LIMIT 0, 1";
							pstmt		= conn.prepareStatement(query);
							pstmt.setInt(1, diaryId);
							rs			= pstmt.executeQuery();
							...
							if (rs.next()) {
							%>
							<a class="next" href="lee_diary.jsp?id=<%=rs.getInt("ID")%>">&gt;&gt;</a>
							<%} else {%>
					...
					<div class="dayfood">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="105" align="center" bgcolor="#EF6797" style="color:#FFF;">제공된<br />잇슬림제품</td>
								<td bgcolor="#F4F4F4">
									<ul class="dailylist">
										<li><%=imgUrl%></li>
										<div class="clear"></div>
					...
					<div class="comment-wrap">
						...
						<form name="reply_write" method="post" action="diary_db.jsp">
							...
							<input type="hidden" name="return_url" value="lee_diary">
							...
							%>
								<div class="commentheader">
									...
									<div class="myadmin">
										...
										<a href="lee_diary.jsp?id=<%=diaryId%>&reply_id=<%=replyId%>">수정</a>
										|
