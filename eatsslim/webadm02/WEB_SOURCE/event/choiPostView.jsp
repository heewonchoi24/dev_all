...
%>
	...
	<script src="choiPostView.js"></script>
</head>
<body>
<div id="wrap">
	<div id="header">
					...
					<div class="post-wrapper">
						<div class="post-read">
							...
							<div class="col center">
								<div class="button small dark"><a href="/event/choiPost.jsp?<%=param%>">목록</a></div>
								<% if(inst_id.equals(eslMemberId)){%>
								<div class="button small dark"><a href="javascript:;" onclick="window.open('/event/choiPostWrite.jsp?id=<%=postId + param%>','choiPost','width=1024,height=600,scrollbars=1')">수정</a></div>
									...
									<li class="comment depth-1" >
										...
										<div class="commentheader">
											...
											<div class="myadmin">
												...
												<a href="/event/choiPostView.jsp?<%=param%>&id=<%=postId%>&reply_idx=<%=reply_idx%>">수정</a> ㅣ <a href="javascript:reply_del('<%=reply_idx%>');">삭제</a>
												<% } %>
											</div>
										</div>
		...
		<div class="sidebar four columns">
			<div class="colums-side">
				<ul class="listNavi">
					...
					<li class="active"><a href="/event/choiPost.jsp?<%=param%>"><span class="current"></span>목록</a></li>
					<li class="last">
						<%
