	...
	<div class="container">
		...
		<div class="sixteen columns offset-by-one">
			<div class="row">
				<!--div class="one last col">
					<div class="graytitbox">
						<ul class="filter floatleft" style="margin-top:5px;">
							<li <% if(p_gubun.equals("")){ %> class="current" <% } %>><a href="observe.jsp">ALL(<%=gubun_all_cnt%>)</a></li>
							<li <% if(p_gubun.equals("1")){ %> class="current" <% } %>><a href="?p_gubun=1" >최과장(<%=gubun1_cnt%>)</a></li>
							<li <% if(p_gubun.equals("2")){ %> class="current" <% } %>><a href="?p_gubun=2" >이대리(<%=gubun2_cnt%>)</a></li>
						</ul>
				...
				<img src="/images/observe_top.jpg" alt="" />
			</div>
			<!-- End Row -->
			<div class="row">
				<div class="one last col" id="dietList">
					<div class="fluidbox">
						...
						<div class="box">
							<div class="article">
								<a href="/event/observeView.jsp?id=<%=observeId + param%>">
		...
		$(data).find("result").each(function() {
			if ($(this).text() == "success") {
				...
				$(data).find("diet").each(function() {
					...
					dietHtml +='<a href="/event/observeView.jsp?id='+ dietArr[0] +'">';
