...
if (mode != null) {
	...
	if (mode.equals("write")) {
		...
		out.print("<script>alert('등록되었습니다');location.href='observeView.jsp?"+param+"';</script>");
		...
		out.print("<script>alert('수정되었습니다');location.href='observeView.jsp?"+param+"';</script>");
		...
		out.print("<script>alert('삭제되었습니다');location.href='observeView.jsp?"+param+"';</script>");
	}
