...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h2>워킹맘&가사맘 다이어트 스토리</h2>
			<div class="pageDepth">
				HOME &gt; 이벤트 &gt; <strong>주부 다이어트 대결</strong>
			</div>
			<div class="clear"></div>
		</div>
		<div class="sixteen columns offset-by-one">
			<div class="row">
				<!--div class="one last col">
					<div class="graytitbox">
						<ul class="filter floatleft" style="margin-top:5px;">
							...
							<li <% if(p_gubun.equals("1")){ %> class="current" <% } %>><a href="?p_gubun=1" >워킹맘(<%=gubun1_cnt%>)</a></li>
							<li <% if(p_gubun.equals("2")){ %> class="current" <% } %>><a href="?p_gubun=2" >가사맘(<%=gubun2_cnt%>)</a></li>
						</ul>
				...
				<img src="/images/promotion/201404/housewife_top.jpg" alt="워킹맘vs가사맘" usemap="#map1" />
				<map name="Map1">
					<area shape="rect" coords="620,235,976,297" href="/event/eventView.jsp?id=52&pgsize=10" target="_self" alt="응원 댓글 작성하고 쿠폰받기">
				</map>
			</div>
			<!-- End Row -->
			<div class="row">
