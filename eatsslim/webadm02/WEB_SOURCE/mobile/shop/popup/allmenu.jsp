...
<div class="pop-wrap">
	...
	<div class="contentpop">
		<ul class="ui-listview">
			...
			<li class="ui-li ui-li-static ui-btn-up-c"><a href="javascript:;" onClick="moveUrl('/mobile/shop/mypage/index.jsp');" class="font-blue">마이잇슬림</a></li>
			<ul class="ui-listview">
				<li class="ui-li ui-li-static ui-btn-up-e"><a href="javascript:;" onClick="moveUrl('/mobile/shop/mypage/index.jsp');">마이잇슬림 홈</a></li>
