	...
	<div id="content" style="margin-top:135px;">
		...
		<div class="grid-navi">
			<table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					<td><a href="/mobile/shop/dietMeal.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner1"><span class="ui-btn-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;퀴진&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span><span class="active"></span></a></td>
					<td><a href="/mobile/shop/dietMeal-alacarteA.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner1"><span class="ui-btn-text">알라까르떼 슬림</span></span></a></td>
                    <td><a href="/mobile/shop/dietMeal-alacarteB.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner1"><span class="ui-btn-text">알라까르떼 헬씨</span></span></a></td>
				</tr>
			</table>
		</div>
		<div class="row">
			<div class="bg-gray font-brown">
				<p>퀴진은 나트륨 Down, 칼로리 Down 건강식단으로 만나보는 Designed Diet Meal입니다.</p>
				<div style="margin:25px 0 30px 0;"><img src="/mobile/images/img_top_goods01.jpg" width="100%" alt="" /></div>
				<div class="memo">
					<div class="ribbon-tit"></div>
					<ul>
						<li class="memo01">총 20가지 다양한 메뉴로 질리지 않는 즐거운 식사</li>
		...
		<div class="row">
			...
			<ul class="ui-listview">
				...
				query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG,PORTION_SIZE FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 7 AND USE_YN = 'Y' ORDER BY GS.ID";
