  ...
  <div id="content" style="margin-top:135px;">
    ...
    <div class="grid-navi">
      <table class="navi" cellspacing="10" cellpadding="0">
        <tr>
          <td><a href="/mobile/shop/reductionProgram.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner"><span class="ui-btn-text">감량<br />
            프로그램</span></span><span class="active"></span></a></td>
          <td><a href="/mobile/shop/keepProgram.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">유지<br />
            프로그램</span></span></a></td>
    ...
    <div class="row">
      <div class="bg-gray font-brown">
        <p>감량을 체계적으로 원하는 고객을 위하여 밸런스쉐이크/다이어트수프/식사다이어트로 스케쥴링 되어 제공되는 맞춤형 식사 프로그램!</p>
    ...
    <div class="row">
      ...
      <h3>2주 프로그램</h3>
      <p class="f14">집중감량기1, 집중감량기2 총 2주 프로그램으로, 1~2주 기간에 집중적으로 체중을 감량할 수 있도록 구성된 상품입니다.</p>
      <div style="margin:20px auto 5px;"><img src="/mobile/images/reductionProgram03.png" width="100%"></div>
      <h3>4주 프로그램</h3>
      <p class="f14">집중감량기1, 집중감량기2, 감량기, 적응기 총 4주 프로그램으로, 1~2주 기간에는 집중적으로 체중을 감량시키고, 3~4주 기간에는 감량을 지속하면서 다이어트 후에 줄어든 식사량을 서서히 적응할 수 있도록 구성된 상품입니다.</p>
