...
query		= "SELECT C.GROUP_ID, C.BUY_QTY, C.DEVL_TYPE, C.DEVL_DAY, C.DEVL_WEEK, DATE_FORMAT(C.DEVL_DATE, '%Y.%m.%d') WDATE, C.PRICE, C.BUY_BAG_YN, G.GUBUN1, G.GROUP_CODE, G.GROUP_NAME, G.CART_IMG";
...
<div id="wrap">
	...
	<div id="content">
		...
		%>
		<dl class="itemlist">
			<dt style="width:70%;"><%=groupName%>/<%=buyQty%>개<p class="font-gray">식사기간:<%=devlPeriod%> / 첫배송일 : <%=devlDate%></p></dt>
		...
		<ul class="form-regist">
			...
			<li>
				...
				<span style="display:inline-block; width:76%;">
					...
					<a href="/mobile/shop/popup/zipcode.jsp?ztype=1" class="ui-btn ui-mini ui-btn-inline ui-btn-up-b iframe"><span class="ui-btn-inner"><span class="ui-btn-text">우편번호</span></span></a>
					<br />
		...
		<ul class="form-regist">
			...
			<li>
				...
				<span style="display:inline-block; width:76%;">
					...
					<a href="/mobile/shop/popup/zipcode.jsp?ztype=2" class="ui-btn ui-mini ui-btn-inline ui-btn-up-b iframe"><span class="ui-btn-inner"><span class="ui-btn-text">우편번호</span></span></a>
					<br />
...
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/mobile/xpayMobile/order.payreq.jsp" target="_new">
