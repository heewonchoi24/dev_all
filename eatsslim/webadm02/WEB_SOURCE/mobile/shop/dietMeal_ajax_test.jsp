...
/*
			if (buyQty > 0) {
				price		= (int)Math.round((double)price * (double)(100 - 5) / 100);
			} else {		
				price		=  price;
			}
*/
			if (addGoods > 1) {
				if (Integer.parseInt(devlWeek) == 2) {
					price		= price - 5000;
				} else if (Integer.parseInt(devlWeek) == 4) {
					price		= price - 10000;
				} else {
					price		= (int)Math.round((double)price * (double)(100 - 20) / 100);
				}
			} else {		
				price		=  price;
			}
