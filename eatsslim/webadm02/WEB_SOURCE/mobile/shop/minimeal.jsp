...
<div id="wrap">
  ...
  <div id="content" style="margin-top:135px;">
	...
	<div class="grid-navi">
      <table class="navi" border="0" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td><a href="/mobile/shop/minimeal-order.jsp" class="ui-btn ui-btn-inline ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">잇슬림 미니밀 구매하기</span></span></a></td>
        </tr>
      </table>
    </div>
	<div class="grid-navi">
      <table class="navi" cellspacing="10" cellpadding="0">
        <tr>
          <td>
			 <a href="/mobile/shop/minimeal.jsp" class="ui-btn ui-btn-inline ui-btn-up-a">
		...
		<tr class="easyMeal">
			<td colspan="2">
				<span><a class="here" href="/mobile/shop/minimeal.jsp">잇슬림 미니밀</a></span>
				<span><a href="/mobile/shop/secretSoup.jsp">시크릿수프</a></span>
			</td>
	    </tr>
      </table>
    </div>
    ...
    <div class="row">
      <ul class="ui-listview">
        <%
					...
					query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG,PORTION_SIZE FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 13 AND GS.USE_YN = 'Y' ORDER BY GS.ID";
   ...
   공휴일은 택배 발송 및 수령이 불가능</span>합니다.</li>
		<li>하단 표와 같이 <span>수요일이 공휴일인 경우,</span> 택배사 휴무로 인하여 배송과 출고가 없기 때문에, 수요일, 목요일 이틀간 제품을 수령하실 수 없으시며, 목요일, 금요일 주문 건은 기존 배송체계와 같이 차주 화요일에 수령됩니다. </li><br/>
    ...
    <div class="grid-navi">
      <table class="navi" border="0" cellspacing="10" cellpadding="0">
        <tr>
          <td><a href="/mobile/shop/popup/ssoup_term.jsp" class="ui-btn ui-btn-inline ui-btn-up-d iframe"><span class="ui-btn-inner"><span class="ui-btn-text">상품정보</span></span></a></td>
          <td><a href="/mobile/shop/minimeal.jsp" class="ui-btn ui-btn-inline ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">잇슬림 미니밀 구매하기</span></span></a></td>
        </tr>
      </table>
    </div>
  </div>
