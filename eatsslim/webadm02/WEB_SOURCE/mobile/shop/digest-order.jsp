...
query		= "SELECT ID, GROUP_NAME, GROUP_PRICE, GROUP_INFO, OFFER_NOTICE, GROUP_CODE FROM ESL_GOODS_GROUP WHERE GUBUN1 = '50' AND GUBUN2 = '02' AND GROUP_CODE = '0301317' ";
...
<div id="wrap">
	...
	<form name="frm_order" id="frm_order" method="post">
		...
		<div id="content" style="margin-top:135px;">
			<h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">다이제스트 제품구매</span></span></h1>
