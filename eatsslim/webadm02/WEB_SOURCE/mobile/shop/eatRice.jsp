  ...
  <div id="content" style="margin-top:135px;">
	...
	<div class="grid-navi">
      <table class="navi" border="0" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td><a href="/mobile/shop/eatRice-order.jsp" class="ui-btn ui-btn-inline ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">잇슬림 라이스 구매하기</span></span></a></td>
        </tr>
      </table>
    </div>
	<div class="grid-navi">
      <table class="navi" cellspacing="10" cellpadding="0">
		...
		<tr class="easyMeal">
			<td colspan="2">
				<span><a href="/mobile/shop/minimeal.jsp">잇슬림 미니밀</a></span>
				<span><a class="here" href="/mobile/shop/eatRice.jsp">잇슬림 라이스</a></span>
    ...
    <div class="row">
      <ul class="ui-listview">
        <%
					...
					query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG,PORTION_SIZE FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 12 AND GS.USE_YN = 'Y' ORDER BY GS.ID";
    ...
    <div class="row">
	  ...
	  <ul class="step04">
		...
		<li>평일 및 일반 배송 수령일 주문 시, 익일 발송이 가능한 요일인 <span>화, 수, 목, 금, 토요일만</span> 익일 수령 
   가능하며, 주문하신 날로부터 최대 3~5일정도 소요됩니다.</li>
