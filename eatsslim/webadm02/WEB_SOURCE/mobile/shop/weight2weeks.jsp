		...
		<div class="grid-navi">
			<table class="navi" border="0" cellspacing="10" cellpadding="0">
				<tr>
					...
					<td><a href="/mobile/shop/weight2weeks-order.jsp" class="ui-btn ui-btn-inline ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">프로그램다이어트 구매</span></span></a></td>
				</tr>
			</table>
		</div>
		<div class="grid-navi">
			<table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					...
					<td><a href="/mobile/shop/secretSlimming.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">시크릿<br />6일</span></span></a></td>
					<td><a href="/mobile/shop/weight2weeks.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner"><span class="ui-btn-text">집중감량<br />2주</span></span></a></td>
		...
		<div class="row">
			<div class="bg-gray font-brown">
				...
				<div style="margin: 25px 0 10px 0;">
					<img src="/mobile/images/weight2weeks01.png" width="100%" alt="" />
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div style="margin: 5px auto 15px;">
				<img src="/mobile/images/weight2weeks02.png" width="100%" style="margin-bottom: 10px" />
				<p class="f14">단기간 체중 감량을 목표로 하시는 분들을 위해 집중 감량기로만 구성된 총 2주 프로그램입니다.</p>
			</div>
			<h3>4주 프로그램</h3>
			<p class="f14">집중 감량기 Step1 1주차, 집중 감량기 Step2 2주 총 2주 프로그램으로 단기간 체중 감소를 목표로 하시는분 위한 구성된 상품입니다.</p>
			<div class="divider"></div>
			<h2 class="font-brown">02. 체계적인 식사 스케쥴</h2>
			<div style="margin: 5px auto;">
				<img src="/mobile/images/weight2weeks03.png" width="100%" />
			</div>
			<div class="divider"></div>
			...
			<div class="divider"></div>
			<h2 class="font-brown">05. 조리+제조=스마트 키친</h2>
			<ul class="dot">
				<li class="f14">HACCP인증 조리 시설</li>
				<li class="f14">안전한 원자재 관리</li>
				<li class="f14">안전한 제품생산 과정</li>
				<li class="f14">맛을 살리는 특별한 조리 방법</li>
			</ul>
			<div class="divider"></div>
			...
			<p class="f14">스마트키친을 통한 품질의 표준화 및 전문화</p>
			<div class="divider"></div>
