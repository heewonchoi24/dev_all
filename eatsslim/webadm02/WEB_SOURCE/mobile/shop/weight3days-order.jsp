...
<div id="wrap">
	...
	<form name="frm_order" id="frm_order" method="post">
		...
		<div id="content" style="margin-top:135px;">
			<h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">잇슬림 3일 프로그램 제품구매</span></span></h1>
							...
							<li>
								<div class="select-box">
									<select name="gubun2" id="gubun2">
										<option value="26">잇슬림 3일 프로그램</option>
									</select>
								</div>
								<div class="clear"></div>
							</li>
...
function addCart(t) {
	$("#cart_type").val(t);
	$.post("3daysProgram_ajax.jsp", $("#frm_order").serialize(),
	function(data) {
