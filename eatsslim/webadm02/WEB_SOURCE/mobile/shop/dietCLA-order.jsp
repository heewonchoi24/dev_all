...
<div id="wrap">
	<div class="ui-header-fixed" style="overflow:hidden;">
		...
		<ul class="subnavi">
			...
			<li class="current"><a href="/mobile/shop/dietCLA.jsp">풀비타</a></li>
		</ul>
	</div>
	<!-- End ui-header -->
	<!-- Start Content -->
	<form name="frm_order" id="frm_order" method="post">
		...
		<div id="content" style="margin-top:135px;">
			<h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">다이어트CLA 제품구매</span></span></h1>
...
function addCart(t) {
	$("#cart_type").val(t);
	$.post("chewable_ajax.jsp", $("#frm_order").serialize(),
	function(data) {
