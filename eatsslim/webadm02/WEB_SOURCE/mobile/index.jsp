...
%>
	...
	if (mobile) {
		...
		alert(userAgent);
		if (((userAgent.search("android") > -1) && ((userAgent.search("4.1") > -1) || (userAgent.search("4.2") > -1) || (userAgent.search("4.3") > -1))) || ((userAgent.search("iphone") > -1) || (userAgent.search("ipad") > -1))) {
...
<div id="wrap" class="home">
	...
	<div id="content" class="main-page">
			...
			<div id="index_slides" class="index_slides">
				<div class="index_slideri" id="index_slideri_1">
					<div class="index_inner_wrap">
						<div class="caption">바른 식습관,<br><strong>체계적인 다이어트</strong></div>
				...
				<div class="index_slideri" id="index_slideri_2">
					<div class="index_inner_wrap">
						...
						<a href="/mobile/shop/weight2weeks.jsp" class="ui-btn ui-mini ui-btn-inline ui-btn-icon-right ui-btn-up-c">
							<span class="ui-btn-inner">
								<span class="ui-btn-text">주문하기</span>
								<span class="ui-icon ui-icon-arrow-r blueicon"></span>
							</span>
				...
				<div class="index_slideri" id="index_slideri_3">
					<div class="index_inner_wrap">
						...
						<a href="/mobile/shop/minimeal.jsp" class="ui-btn ui-mini ui-btn-inline ui-btn-icon-right ui-btn-up-c">
							<span class="ui-btn-inner">
								<span class="ui-btn-text">주문하기</span>
								<span class="ui-icon ui-icon-arrow-r blueicon"></span>
							</span>
		...
		<a class="ad-banner" href="https://www.eatsslim.co.kr/mobile/event/index.jsp">
			<img src="/mobile/images/main_event.jpg" width="314" height="111" alt="진행중인이벤트" />
		</a>
	</div>
	<!-- End Content -->
	<div class="ui-footer">
