 ...
 * @cat Plugins/Methods/Date
 */
Date.abbrMonthNames = ['1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월'];
...
(function() {
	 ...
	 * @example var dtm = new Date("01/12/2008");
	 * dtm.asString();
	 * @result '12/01/2008' // (where Date.format == 'yyyy/mm/dd'
	 * 
	 * @name asString
	 * @type Date
	 * @cat Plugins/Methods/Date
	 ...
	 * dtm.toString();
	 * @result 'Sat Jan 12 2008 00:00:00' // (where Date.format == 'yyyy/mm/dd'
	 * 
	 * @name fromString
	 * @type Date
	 * @cat Plugins/Methods/Date
