...
function mini_command(idx,str,value)
{
	...
	switch (str){
		...
		case "InsertTable":
			...
			return; break;
		case "InsertImage":
			window.open(mini_path + "popup.image.jsp?code=board&idx=" + idx,"","width=400,height=310");
			return; break;
	}
...
{
	var name = new Array("±¼¸²","µ¸¿ò","¹ÙÅÁ","±Ã¼­","±¼¸²Ã¼","Arial","Courier","Tahoma","-À±°íµñ120","¸¼Àº °íµñ");
...
function miniEditorFrame(obj,idx)
{
	...
	<head>\
		...
		<style>body {margin:10px;} body,table {font-size:13px;} p {margin:2px 0}</style>\
	</head>\
	";
	...
	miniEditorIframe.setAttribute("height",400);
