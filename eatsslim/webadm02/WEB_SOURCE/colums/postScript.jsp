...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>다이어트 체험후기</h1>
			<div class="pageDepth">
				HOME &gt GO! 다이어트 &gt <strong>다이어트 체험후기</strong>
			</div>
			<div class="clear"></div>
		</div>
                ...
                <div class="one last  col">
                    <div class="graytitbox">
						...
						<%	if (eslMemberId == null || eslMemberId.equals("")) { %>
							<a class="lightbox" href="/shop/popup/loginCheck.jsp?lightbox[width]=600&lightbox[height]=350">체험후기 작성</a>
						<%	} else {	%>
							<a href="javascript:;" onclick="window.open('/colums/postWritePopup.jsp','PostWrite','width=1024,height=600,scrollbars=1')">체험후기 작성</a>
						<%	} %>
						</div>
                    </div>
                </div>
				   ...
				   <div class="fluidbox best">
					...
					<div class="box<%=divClass%>">
                        <div class="article">
                              ...
                              <p class="cate">[ <%=ut.getPostType(pressUrl)%> ]</p>
                              <a href="/colums/postScriptView.jsp?id=<%=pressId + param%>">
                    ...
                    <div class="graytitbox">
                        <ul class="filter floatleft" style="margin-top:5px;">
                            ...
                            <li <% if(p_gubun.equals("3")){ %> class="current" <% } %>><a href="?p_gubun=3" >타입별다이어트(<%=gubun3_cnt%>)</a></li>
							 <li <% if(p_gubun.equals("4")){ %> class="current" <% } %>><a href="?p_gubun=4" >이벤트후기(<%=gubun4_cnt%>)</a></li>
                        </ul>
