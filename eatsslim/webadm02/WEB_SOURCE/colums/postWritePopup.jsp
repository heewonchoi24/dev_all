                      ...
                      <tr>
                        ...
                        <td class="td">
							<select name="press_url" id="press_url">
								...
								<option value="4"<%if(pressUrl.equals("4")){out.print(" selected");}%>>이벤트후기</option>
								<option value="1"<%if(pressUrl.equals("1")){out.print(" selected");}%>>식사다이어트</option>
								<option value="2"<%if(pressUrl.equals("2")){out.print(" selected");}%>>프로그램다이어트</option>
								<option value="3"<%if(pressUrl.equals("3")){out.print(" selected");}%>>타입별다이어트</option>
							</select>				
						</td>
                      </tr>
