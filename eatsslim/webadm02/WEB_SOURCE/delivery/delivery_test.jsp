			...
			<div class="row">
				<div class="one last col">
					<div class="sectionHeader">
						...
						<span class="floatright button small dark"><a href="javascript:;" onclick="window.open('deliverypossi_test.jsp','delivery_chk','width=900,height=650,top=50,left=100,scrollbars=yes,resizable=no,toolbar=no,status=no,menubar=no')">우리집 배달가능여부 확인</a></span>
						<div class="clear"></div>
					</div>
...
function showZipcode(sido, gugun) {
	ifrmHidden.location.href = "delivery_ajax_test.jsp?sido="+ sido +"&gugun="+ gugun;
}
</script>
