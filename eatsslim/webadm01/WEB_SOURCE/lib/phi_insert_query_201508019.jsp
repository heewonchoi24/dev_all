...
if (chkCnt < 1) {
	...
	while (rs.next()) {
		...
		if (gubun2.equals("31")) {
				...
				if (devlDay.equals("3")) {
					...
					if (cal.get(cal.DAY_OF_WEEK) == 7 || cal.get(cal.DAY_OF_WEEK) == 1) { // 토, 일요일은 배송을 하지 않는다	
						...
						if (gubun1.equals("02")) {
							...
							query2		+= " WHERE  ('"+today+"' BETWEEN STDATE AND LTDATE) AND (GROUP_CODE = '"+groupCode+"'  or GROUP_CODE is null) ";
			...
			if (devlDatePhi.equals("2014-09-05") || devlDatePhi.equals("2014-09-06") || devlDatePhi.equals("2014-09-07") || devlDatePhi.equals("2014-09-08") || devlDatePhi.equals("2014-09-09") || devlDatePhi.equals("2014-09-10")) {
				devlDatePhi		= "2014-09-11";
			}
