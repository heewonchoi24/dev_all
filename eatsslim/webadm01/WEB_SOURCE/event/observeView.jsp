...
if (request.getParameter("id") != null && request.getParameter("id").length() > 0) {
	...
	//댓글수
	query		= "SELECT COUNT(ID) FROM ESL_EVENT_OBSERVE_REPLY where ID="+noticeId+"";
...
<script src="observeView.js"></script>
</head>
<body>
<div id="wrap">
	<div id="header">
	...
	<div class="container">
		<div class="maintitle">
			<h1>최과장&amp;이대리 밀착감시</h1>
			<div class="pageDepth">
				HOME &gt; 이벤트 &gt; <strong>최과장&amp;이대리 밀착감시</strong>
			</div>
			<div class="clear">
			</div>
		</div>
			    ...
			    <div class="one last  col">
				   <div class="post-wrapper">
				      <div class="post-read">
						  ...
						  <div class="col center"><div class="button small dark"><a href="/event/observe.jsp?<%=param%>">목록</a></div></div>
						  <div class="comment-wrap">
							  ...
							  <%
									...
									if(reply_idx > 0){
										query		= "SELECT * ";
										query		+= " FROM ESL_EVENT_OBSERVE_REPLY where ID="+noticeId+" and IDX="+reply_idx+" and M_ID='"+eslMemberId+"'";
						      ...
						      <ul>
							    <li class="comment depth-1" >
									...
									<%
									query		= "SELECT * ";
									query		+= " FROM ESL_EVENT_OBSERVE_REPLY where ID="+noticeId+"";
									query		+= " ORDER BY IDX ASC";
								   ...
								   <div class="commentheader">
								      ...
								      <a href="/event/observeView.jsp?<%=param%>&id=<%=noticeId%>&reply_idx=<%=reply_idx%>">수정</a> ㅣ <a href="javascript:reply_del('<%=reply_idx%>');">삭제</a>
									  <% } %>
									   </div>
								   </div>
		...
		<div class="sidebar four columns">
		   <div class="colums-side">
              <ul class="listNavi">
                  ...
                  <li class="active"><a href="/event/observe.jsp?<%=param%>"><span class="current"></span>목록</a></li>
                  <li class="last">
