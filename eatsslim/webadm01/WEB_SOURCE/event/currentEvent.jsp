...
<div id="wrap" class="added">
	...
	<div class="container">
		<div class="maintitle">
			<h1>진행중인 이벤트</h1>
			<div class="pageDepth">
				<span>HOME</span><span>이벤트</span><strong>진행중인 이벤트</strong>
			</div>
			<div class="eventList_tabmenu">
				<ul>
					<li class="active"><a href="/event/currentEvent.jsp">진행중인 이벤트</a></li>
					<li><a href="/event/lastEvent.jsp">지난 이벤트</a></li>
				</ul>
			</div>
			<div class="clear"></div>
		</div>
					...
					<div class="post-wrapper">
						...
						<div class="eventList ff_noto">
							<ul>
								...
								%>
<!-- 								<li> -->
<!-- 									<div class="img"><a href="eventView.jsp"><img src="/dist/images/event_sample1_wide.jpg" alt="" /></a></div> -->
<!-- 									<div class="info"> -->
<!-- 										<p class="title"><span>이벤트</span>챗봇 모바일 고객센터 오픈 이벤트!</p> -->
<!-- 										<dl> -->
<!-- 											<dt>이벤트기간</dt> -->
...
<!-- 								</li> -->
<!-- 								<li> -->
<!-- 									<div class="img"><a href="eventView.jsp"><img src="/dist/images/event_sample2_wide.jpg" alt="" /></a></div> -->
<!-- 									<div class="info"> -->
<!-- 										<p class="title"><span>이벤트</span>챗봇 모바일 고객센터 오픈 이벤트!</p> -->
<!-- 										<dl> -->
<!-- 											<dt>이벤트기간</dt> -->
...
<!-- 								</li> -->
<!-- 								<li> -->
<!-- 									<div class="img"><a href="eventView.jsp"><img src="/dist/images/event_sample3_wide.jpg" alt="" /></a></div> -->
<!-- 									<div class="info"> -->
<!-- 										<p class="title"><span>이벤트</span>챗봇 모바일 고객센터 오픈 이벤트!</p> -->
<!-- 										<dl> -->
<!-- 											<dt>이벤트기간</dt> -->
