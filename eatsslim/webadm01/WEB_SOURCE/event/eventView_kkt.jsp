							...
							<ul class="meta-wrap">
								...
								<div class="share floatright">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:;" onclick="shareStory();">a</a>
                                        </li>
								        <li>
                                            <a href="javascript:;" onclick="shareNaverBlog();" target="_blank">b</a>
                                        </li>
                                    </ul>
                                 </div>
                            </ul>
...
function shareNaverBlog() {
	...
	var url = encodeURI("/event/eventView.jsp?id=293&pgsize=10");
