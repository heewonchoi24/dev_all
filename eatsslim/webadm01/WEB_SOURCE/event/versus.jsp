		...
		<div class="row">
			<div id="event01" class="marb50">
				<ul class="promotiontabNavi marb20">
					...
					<li><a href="/event/observe.jsp" target="_blank"><img src="/images/promotion/pr1120/btn_04_off.png" width="334" height="56" alt="event-3" /></a></li>
					<div class="clear"></div>
				</ul>
				<div class="eventchapter" style="background:url(/images/promotion/pr1120/pr_top.jpg) no-repeat 0 0; width:1024px; height:756px;">
					<a href="javascript:;" onclick="versus();" class="support a-part"></a>
					<a href="javascript:;" onclick="versus();" class="support b-part"></a>
					<div class="a-account">
			...
			<div id="event03" class="marb50">
				<ul class="promotiontabNavi marb20">
					...
					<map name="Map">
                      <area shape="rect" coords="20,90,226,140" href="/event/schedule_5.jsp" target="_blank" alt="최과장님 식단 보기">
                      <area shape="rect" coords="800,90,980,140" href="/event/schedule_5.jsp" target="_blank" alt="이대리님 식단 보기">
