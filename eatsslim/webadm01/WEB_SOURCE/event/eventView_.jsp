...
function UccLink() {
	...
	var URL = '<div style="margin:0 auto;text-align:center;position:relative;background:url(https://www.eatsslim.co.kr/images/event_20131120_scrap.jpg) no-repeat 0 0;width:600px;height:3062px;"><div style="position:absolute;left:181px;bottom:19px;width:238px;height:53px;display:block;"><a href="https://www.eatsslim.co.kr/event/versus.jsp" target="_blank"><img src="https://www.eatsslim.co.kr/images/event_20131120_scrap_btn.jpg" width="238" height="53" alt="이벤트 바로가기" /></a></div></div>';
