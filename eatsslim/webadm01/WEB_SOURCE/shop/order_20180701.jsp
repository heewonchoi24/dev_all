					...
					<div class="impor-wrap f16">
						<div class="floatleft half">
							<ul>
								...
								<li>
									사용 가능 쿠폰 <strong class="f22 font-maple"><%=couponCnt%>장</strong>
								</li>
				...
				<div class="one last col">
					...
					<div class="guide bg-gray">
					    <ul>
							...
							<li>일일배달 상품의 경우 22시~6시에 배송되므로, 새벽출입 방법에 대해 자세히 적어주세요. (특이사항은 1:1 게시판 또는 고객센터로 연락주세요)</li>
						</ul>
					</div>
					<!-- End Table -->
				</div>
...
function myAddr() {
	...
	if ($("#devl_check").val() == "N") {
		alert("고객님의 일일배달 배송지는 배송이 불가능한 지역입니다.\n새로운 배송지를 입력해주세요.");
		$("input[name=devl_type]")[2].click();
	} else {
		if (f.rcv_name) {
