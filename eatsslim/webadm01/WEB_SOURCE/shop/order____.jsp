						...
						if (tcnt > 0) {
							...
							while (rs.next()) {
								...
								if (gubun1.equals("01") || gubun1.equals("02") || rs.getString("DEVL_TYPE").equals("0001")) {
									...
									} else if (groupId == 75 || groupId == 76 || groupId == 77 || groupId == 81 || groupId == 79 || groupId == 80 || groupId == 102 || groupId == 103 ) {
									...
									} else if (groupId == 93 || groupId == 94 || groupId == 95 || groupId == 96 || groupId == 97 || groupId == 104) {
...
%>
							  <input name="pay_type" type="radio" value="90" required label="결제수단선택" />전화결제 
<%
} else {
%>
