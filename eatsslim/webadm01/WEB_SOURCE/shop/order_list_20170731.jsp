							...
							<div class="slogan">
								...
								<%
									if(menuF.equals("1")){
										%>
										<h2>다이어트식</h2>
										<p>샐러드, 덮밥, 정찬 형태 등 다양한 스타일과<br>다양한 메뉴로 구성된 맛있는 다이어트식</p>
										<%
									}else if(menuF.equals("2")){
										%>
										<h2>다이어트 프로그램</h2>
										<p>원하는 감량 목표에 따라 선택 가능한<br>체계적이고 과학적인 다이어트 프로그램</p>
										<%
									}else if(menuF.equals("3")){
										%>
										<h2>건강식</h2>
										<p>나트륨, 칼로리 조절, Low GL을 적용한<br>건강 관리와 체중 관리를 위한 건강식</p>
										<%
									}else if(menuF.equals("4")){
										%>
										<h2>건강식품</h2>
										<p>풀무원의 건강식품 전문브랜드 풀비타,<br>풀무원이 만들어 믿을 수 있는 건강즙 등 풀무원의 다양한 건강식품</p>
										<%
									}
									else if(!"".equals(tg)){
										// 05:추천,06:베스트
										if("05".equals(tg) ){
											out.println("<h2>추천상품</h2><p>건강하고 맛있는 다이어트,<br>잇슬림에서 추천하는 상품을 소개합니다.</p>");
										}
										else if("06".equals(tg) ){
											out.println("<h2>베스트상품</h2><p>건강하고 맛있는 다이어트,<br>잇슬림에서 가장 사랑받는 베스트상품을 소개합니다.</p>");
										}
									}
					...
					<div class="goods_filter">
						<form action="">
								...
								<dd>
									<!-- <div class="bx_select_filter bx_filter">
										...
										<%
											if(menuF.equals("1")){
												%>
												<li><button type="button" id="btn1" data-line-opts="quisine" onclick="btn(11);"><span>퀴진</span></button></li>
												...
												%>
												<li><button type="button" id="btn1" data-line-opts="healthy" onclick="btn(31);"><span>헬씨퀴진</span></button></li>
												<%
											}else if(menuF.equals("4")){
												%>
									...
									<div class="bx_select_filter bx_select">
										<div class="selectWrap">
											...
											<%
												if(menuF.equals("1")){
											%>
												<option <%if(menuS.equals("1")) out.println(" selected=\"selected\""); %> value="11">퀴진</option>
												<option <%if(menuS.equals("2")) out.println(" selected=\"selected\""); %> value="12">알라까르떼 슬림</option>
												<option <%if(menuS.equals("3")) out.println(" selected=\"selected\""); %> value="13">알라까르떼 헬씨</option>
												<option <%if(menuS.equals("4")) out.println(" selected=\"selected\""); %> value="14">미니밀</option>
											<%
												}else if(menuF.equals("2")){
											%>
												<option <%if(menuS.equals("1")) out.println(" selected=\"selected\""); %> value="21">단기프로그램</option>
												<option <%if(menuS.equals("2")) out.println(" selected=\"selected\""); %> value="22">감량프로그램</option>
											...
											%>
												<option <%if(menuS.equals("1")) out.println(" selected=\"selected\""); %> value="31">헬씨퀴진</option>
											<%
												}else if(menuF.equals("4")){
											%>
												<option <%if(menuS.equals("1")) out.println(" selected=\"selected\""); %> value="41">간편식</option>
												<option <%if(menuS.equals("2")) out.println(" selected=\"selected\""); %> value="42">기능식품</option>
							...
							<!-- <dl>
								...
								<dd><div class="bx_select_filter bx_return"><a href="javascript:void(0);">다이어트식으로 돌아가기</a></div></dd>
							</dl> -->
						</form>
					</div>
					<% } %>
