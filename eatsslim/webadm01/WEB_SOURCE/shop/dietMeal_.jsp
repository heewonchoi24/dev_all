					...
					<div class="quizindiet">
						...
						<div class="quizinlist">
							...
							<div class="center">
								...
								<p><p>아래 제품 이미지를 클릭하시면, 상세 영양정보를 확인하실 수 있습니다. 
		...
		<div class="sixteen columns offset-by-one">	
			...
			<div class="row col">
				...
				<div id="detail-delivery">
						...
						<tr>
							<td>배달처</td>
							<td style="text-align:left;">일일배달(각 지역 녹즙가맹점)</td>
						</tr>
						<tr>
						  <td>배달비용</td>
						...
						<tr>
						  <td>배달기간</td>
						  <td style="text-align:left;">식재료 구매~배달까지의 소요 기간이 다르므로, 제품별 주문일에 따른 첫 배달일을 꼭 확인해주세요.</td>
						  </tr>
						<tr>
						  <td>배달시간</td>
						  <td style="text-align:left;">배달일 전날 22~수령일 6시 사이에 배송됩니다. <br />기상악화, 도로사정, 가맹점 상황(배달물량 급증, 현관출입 불가 등)에 따라 조기, 지연 배송될 수 있습니다.</td>
						  </tr>
						 <tr>
						  <td>첫 배달일</td>
						  <td style="text-align:left;">
						  <span class="font-blue">1. 퀴진(1일 1식, 1일 1식+간편식) : </span><span class="font-maple">주문일로부터 4일 후, 첫 배달</span>일 선택이 가능합니다. <br />
						  주문일로부터 4일과 5일에 첫 배달일을 선택할 경우, 구운코코넛오야꼬동세트, 팽이버섯불고기세트가 순차적으로 배달되며, (매일 생산 제품)<br />
						  그 이후 식단은 기존 퀴진식단 스케쥴표대로 배달됩니다. <br />
						  * 주문일로부터 첫 배달일을 6일 후로 선택하는 경우, 기존 퀴진식단 스케쥴표대로 배달됩니다.<br />
						  * 해당 제품 : "1일 1식 퀴진" 또는 "1일 1식 퀴진+ 간편식(미니밀/밸런스쉐이크)"<br />
						  <span class="font-blue">2. 그 외 제품(알라까르떼를 포함하는 모든 제품) : </span><span class="font-maple">주문일로부터 6일 후 첫 배달</span>가능하며, 식단 스케쥴대로 배달됩니다.</td>
						  </tr>	
				    </table>
					<div class="clear"></div>
					</div>
