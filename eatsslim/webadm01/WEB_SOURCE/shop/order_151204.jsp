					...
					<table class="orderList" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<%
							...
							if (dayPrice > 0) {
								...
								query		= "SELECT COUNT(SEQNO) FROM PHIBABY.V_ZIPCODE_OLD WHERE ZIPCODE = '"+ memZipcode +"' AND DLVPTNCD = '01' AND DLVYN = 'Y' AND DLVTYPE = '0001'";
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td colspan="3">
									...
									<input name="tag_addr2" type="text" class="ftfd" style="width:340px; margin-top:5px;" value="<%=memAddr2%>" required label="상세주소" maxlength="50">
								</td>
							</tr>
							<input type="hidden" name="tag_type" value="01" />
							<tr>
