...
<%@ include file="/common/include/inc-top_20140522.jsp"%>
<%
String query			= "";
int groupId				= 0;
int price				= 0;
						...
						<ul class="badgecount">
							...
							<li id="addOption">
								...
								<div class="floatright" style="width:140px;" id="optionSelect">
									...
									<!--font style="font-weight:normal; color:#777;">4/24~30일까지 옵션<br />구매상품 최대 24%할인</font-->
								</div>
								<div class="clear"></div>
							</li>
						</ul>
	...
	function(data) {
		$(data).find("result").each(function() {
			if ($(this).text() == "success") {				
				...
				addOptions		+= "</select>";
				//addOptions		+= '<font style="font-weight:normal; color:#777;">4/24~30일까지 옵션<br />구매상품 최대 24%할인</font>';
				if (num > 0) {
