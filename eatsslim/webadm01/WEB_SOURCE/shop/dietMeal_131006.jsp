						...
						<div class="quizinlist">
							<div class="share floatright">
								<ul>
									...
									<li>
										<a class="me2day" href="#"></a>
									</li>
								</ul>
							</div>
							<div class="clear"></div>
							<h1 class="row center">
								<img src="/images/headcopy_01.png" alt="저열량, 저나트륨으로 디자인된 맛있는 다이어트!" />
							</h1>
							<div class="center">
								<p>
									<img src="/images/quizinA_subject.png" alt="퀴진A" />
								</p>
								<p>
									<img src="/images/quizinA_feature.png" alt="퀴진A 특징" />
								</p>
							</div>
							<!-- 퀴진 리스트 -->
							<div class="foodlist">
								...
								<div class="food<%=divClass%>">
									<div>
										<a class="food-thumb lightbox" rel="group1" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=645&set_id=<%=setId%>" title="<%=setName%>"><img src="<%=imgUrl%>" alt="<%=setName%>" /></a> 
										<a class="food-link lightbox" rel="group1" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=645&set_id=<%=setId%>">
		...
		<form name="frm_order" id="frm_order" method="post">
			...
			<div class="sidebar five columns">
						...
						<ul class="badgecount">
							...
							<li>
								...
								<div class="floatright" style="width:140px;">
									<input id="devl_date" class="dp-applied date-pick" name="devl_date" readonly="readonly" />
								</div>	
								<div class="clear"></div>
							</li>
							<li>
					...
					<div class="itembox">
						<ul class="badgecount">
							<li>
								...
								<p>
									<input name="buy_bag" id="buy_bag" type="checkbox" value="Y" checked="checked" /> 보냉가방 구매 (5,000원)<br />
				...
				<div class="price-wrapper">
					...
					<div class="button large light" style="margin-right:5px;"><a class="lightbox" href="/shop/popup/loginCheck.jsp?lightbox[width]=600&lightbox[height]=350">장바구니</a></div>
					...
					<%} else {%>
					<div class="button large light" style="margin-right:5px;"><a href="javascript:;" onClick="addCart('C');">장바구니</a></div>
					<div class="button large dark iconBtn"><a href="javascript:;" onClick="addCart('B');"><span class="star"></span>바로구매</a></div>
					<%}%>
					<div class="clear"></div>
				</div>  
			</div>
			...
			<div class="row col grayhalf">
				...
				<div class="oneinhalf">
					<a href="#" title="잇슬림으로 다이어트 도전">
						<img class="thumbleft" src="/images/notice_sample.jpg" width="160" height="108" title="[공지]잇슬림 퀴진 변경안내 (불고기 비빔밥 --> 비빔밥)" />
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-delivery">
						<p><img src="/images/detail_delivery.jpg" alt="배송정보" width="999" height="166" /></p>
					</div>
					<div class="divider"></div>
					<ul class="tabNavi marb30">
						<li>
...
$(document).ready(function() {
	...
	$(".plus").click(function() {
		var bag_price	= ($("#buy_bag").is(":checked"))? 5000 : 0;
		...
		$(data).find("result").each(function() {
			if ($(this).text() == "success") {
				...
				$(data).find("menu").each(function() {
					...
					menuHtml		+= '<div>';
					menuHtml		+= '<a class="food-thumb lightbox" rel="group1" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=645" title="'+ menuArr[2] +'"><img src="'+ menuArr[1] +'" alt="'+ menuArr[2] +'" /></a> ';
					menuHtml		+= '<a class="food-link lightbox" rel="group1" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=645">';
