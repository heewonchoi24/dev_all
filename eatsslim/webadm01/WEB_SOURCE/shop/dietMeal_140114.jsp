				...
				<div class="twothird last col">
					<div class="quizindiet">
						<ul class="quizintab">
							...
							<li class="snack">
                                <a href="javascript:;" onclick="cngMenu(4);"></a>
                            </li>
						</ul>
						<div class="quizinlist">
							...
							<div class="foodlist">
								...
								query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 2 AND GS.USE_YN = 'Y' ORDER BY GS.ID";
								pstmt		= conn.prepareStatement(query);
								rs			= pstmt.executeQuery();
							...
							<!-- End 퀴진 리스트 -->
							<!-- 간식 리스트 -->
							<div class="snacklist hidden">
								<div class="snack-wrap">
									<a class="lightbox" rel="group2" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=550&set_id=50" title="간식F">
										<img class="snack-thumb" src="/images/snack_01.jpg" width="318" height="181" />
										<h4>야채스틱</h4>
										<p>신선한 과일이 가득한 새콤달콤 영양간식.</p>
									</a>
								</div>
								<div class="snack-wrap">
									<a class="lightbox" rel="group2" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=550&set_id=52" title="간식F">
										<img class="snack-thumb" src="/images/snack_02.jpg" width="318" height="181" />
										<h4>가바라이스 팝칩</h4>
										<p>맛이 자극적이지 않은 담백 고소한 스낵입니다. 국내산 무농약 정미와 GABA쌀로 기름에 튀기지 않고 구워서 만든 간식입니다.</p>
									</a>
								</div>
								<div class="snack-wrap">
									<a class="lightbox" rel="group2" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=550&set_id=53" title="간식F">
										<img class="snack-thumb" src="/images/snack_03.jpg" width="318" height="181" />
										<h4>녹차라이스 팝칩</h4>
										<p>국내산 무농약 정미와 녹차분말로 기름에 튀기지 않고 구워서 만든 간식입니다. </p>
									</a>
								</div>
							</div>
                            <!-- End 간식 리스트 -->
...
function selGroup() {
	...
	$("#set_holiday").val("");
	if (groupCode == 8 || groupCode == 13) {
		alert("\"알라까르떼F+알라까르떼F\"는\n동일한 메뉴 2개로 구성됩니다.");
	}
	$.post("dietMeal_ajax.jsp", {
		mode: 'selGroup',
		group_id: groupCode
