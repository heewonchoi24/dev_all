...
<div class="pop-wrap">
	...
	<div class="contentpop">
		<div class="popup columns offset-by-one">
			...
			<div class="row">
				<div class="one last col">
					<p>
						...
						* 원료 수급 등의 문제로 실 제품은 변경될 수 있습니다. <br />
						* 잇슬림에서는 불필요한 일회용품 사용을 줄이고, 다이어트 식습관을 길들이기 위해서 일부 메뉴는 젓가락만 제공됩니다. <br />
						- 헬씨퀴진 : 젓가락만 포함 / 퀴진 :  일부 메뉴 숟가락 제공 / 알라까르떼 슬림 : 포크 / 알라까르떼 헬씨 : 스포키
					</p>
			...
			query		+= " WHERE SET_ID = "+ setId +" ORDER BY ID";
			try {
				rs = stmt.executeQuery(query);
			} catch(Exception e) {
				out.println(e+"=>"+query);
			...
			<div class="row">
				<div class="one last col">
					<div class="guide">
						<ul>
							<li><%=makeDate%></li>
							<li>문의 : 잇슬림에 대한 문의는 <strong>마이페이지 1:1 문의</strong> 또는 <strong>☎ 080-800-0434</strong>로 문의주세요.</li>
						</ul>
					</div>
				</div>
			</div>
