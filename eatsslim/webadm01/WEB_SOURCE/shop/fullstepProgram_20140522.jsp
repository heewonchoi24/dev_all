...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>Full-Step 프로그램</h1>
			<div class="pageDepth">
				HOME &gt; SHOP &gt; 프로그램 다이어트  &gt; <strong>Full-Step 프로그램</strong>
			</div>
			<div class="clear"></div>
		</div>
				...
				<div class="twothird last col">
					<div class="dietcontent">
						<div class="head" style="padding:25px 0;">
							...
							<p class="f24 bold8">Full-Step 프로그램(4주)</p>
						</div>
						<div style="margin:20px auto 0;">
							...
							<img src="/images/fullstep_pr.png" width="640" height="360" alt="Full-Step 프로그램">
						</div>
						<div class="clear"></div>
					</div>
				</div>
		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row col">
				<div class="one last col">
					...
					<div id="detail-item">
						<p><img src="/images/detail_sample_full_1.jpg"></p>
						<%=groupInfo%>
					</div>
					<div class="divider"></div> 
					<ul class="tabNavi marb30">
