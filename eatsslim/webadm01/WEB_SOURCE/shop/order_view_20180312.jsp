								...
								<tr>
									...
									<td>
										<div class="inp_thermos">
											<input type="checkbox" id="buy_weekend" name="buy_weekend" checked="checked" /> <label for="buy_bag">토, 일 포함</label>
											<p>주말식단 선택 시 토,일 제품(4팩)이 추가되어 금요일에 함께 배송됩니다.</p>
										</div>
									</td>
								</tr>
<% } %>
									...
									<td>
										<div class="inp_thermos">
											<%
												if(bagCnt < 1){
													%>
													<input type="checkbox" id="buy_bag" name="buy_bag" checked="checked" /> <label for="buy_bag">보냉가방 구매 (4,000원)</label>
													<%
												}else if(bagCnt > 0){
													%>
											...
											%>
											<p>기존에 구매한 잇슬림 전용 보냉가방이 있는 경우, 체크박스를 해제해 주세요.</p>
										</div>
									</td>
								</tr>
