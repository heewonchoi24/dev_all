				...
				<div class="twothird last col">
					<div class="dietcontent">
                        ...
                        <ul class="ssoup-list">
                           ...
                           <img src="/images/ssoup_01_01.jpg" width="211" height="139" alt="레몬바나나">
                              <p>이집트콩토마토풍기니</p>
                             </a>   
                              </li>
                             </a> 
                           ...
                           <img src="/images/ssoup_02_01.jpg" width="211" height="139" alt="블랙초코베리호두">
                              <p>레드빈율무</p>
                              </a>   
                              </li>
                              <li class="last">
                              <a class="lightbox" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=550&set_id=64">   
                           <img src="/images/ssoup_03_01.jpg" width="211" height="139" alt="나타드코코고구마">
                              <p>닭가슴살미역곤약</p> 
                              </a>   
                              </li>
                             <div class="clear"></div> 
...
function addCart(t) {
	$("#cart_type").val(t);
	$.post("secretSoup_ajax_test.jsp", $("#frm_order").serialize(),
	function(data) {
