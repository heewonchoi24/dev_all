							...
							<td>
								<div class="inp_thermos">
									<%
										if(bagCnt < 1){
											%>
											<input type="checkbox" id="opt_buy_bag" name="buy_bag" checked="checked" disabled="disabled"/> <label for="opt_buy_bag">보냉가방 구매 (4,000원)</label>
											<%
										}else if(bagCnt > 0){
											%>
											<input type="checkbox" id="opt_buy_bag" name="buy_bag"/> <label for="opt_buy_bag">보냉가방 구매 (4,000원)</label>
											<%
										}
									%>
...
%>
			...
			<div class="bottom_btn_area">
				<%
					if ( "0301544".equals(groupCode) || "0301546".equals(groupCode) || "0301547".equals(groupCode) || "0301548".equals(groupCode) || "0301549".equals(groupCode)) {
				%>
