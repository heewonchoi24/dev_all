...
rs    = pstmt.executeQuery();
if(rs.next()){
    saleTitle    = ut.isnull(rs.getString("SALE_TITLE") );
    ...
    soldOut                = ut.isnull(rs.getString("SOLD_OUT") );
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="inp_datepicker">
                                    <input type="text" id="opt_day" name="day" class="dp-applied opt-date-pick" readonly/>
                                </div>
                            </td>
                        </tr>
...
%>
            ...
            <div class="bottom_btn_area">
                ...
                <button type="button" id="btnOptionFormOrder" class="btn btn_dgray huge btn_order">주문하기</button>
                <%
                    }
                %>    
            </div>
...
// #selectDevlWeek >> #opt_selectDevlWeek    
// SalePrice >> optSalePrice
// CalAmount >> optCalAmount
        ...
        if(optGroupCode == "0300993"){ //-- 미니밀일경우 한식,양식세트로 적용
            ...
            if(optIsDevlWeek && optGubun1 != "02"){ //-- 요일체크이면서 프로그램다이어트가 아닌상품
                ...
                */
                ...
                /*if ( CouponSaleType == "P" ) {
                    optSaleTotalPrice    = Number((optSalePrice-CouponeSalePrice) * parseInt($("#opt_buyQty").val()));
                } else {
                    optSaleTotalPrice    = Number((optSalePrice * parseInt($("#opt_buyQty").val()))- CouponeSalePrice);
                }
                */
