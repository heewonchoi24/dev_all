...
function confrimPost() {
	...
	if (!$.trim($("#old_address").val())) {
		...
		if (ztype == "1") {
			$("#rcv_old_addr1", opener.document).val($("#old_address").val());
			$("#rcv_old_addr2", opener.document).val($("#address2").val());
			$("#rcv_new_addr1", opener.document).val($("#new_address").val());
			$("#rcv_new_addr2", opener.document).val($("#address2").val());
			$("#rcv_zipcode", opener.document).val($("#new_zipcode").val());
		} else {
			$("#tag_old_addr1", opener.document).val($("#old_address").val());
			$("#tag_old_addr2", opener.document).val($("#address2").val());
			$("#rcv_new_addr1", opener.document).val($("#new_address").val());
			$("#rcv_new_addr2", opener.document).val($("#address2").val());
