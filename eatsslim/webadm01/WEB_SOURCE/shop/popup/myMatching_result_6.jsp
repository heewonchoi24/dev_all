    ...
    <div class="popup columns offset-by-one">
      ...
      <div class="row">
        <div class="one last col center">
          <div class="floatleft">
            <div class="button large darkgreen"><a href="javascript:frameMove('/shop/fullstepProgram.jsp')">제품 상세보기 ></a></div>
            <div class="button large darkbrown"><a href="javascript:frameMove('/shop/fullstepProgram.jsp')">제품 구매하기 ></a></div>
          </div>
