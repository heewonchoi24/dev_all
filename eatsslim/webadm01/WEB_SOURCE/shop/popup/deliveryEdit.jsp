...
<div class="pop-wrap">
	...
	<div class="contentpop">
		<div class="popup columns offset-by-one">
			...
			<%
			query		= "SELECT ";
			query		+= "	PAY_TYPE, RCV_NAME, RCV_TEL, RCV_HP, RCV_ZIPCODE, RCV_ADDR1, RCV_ADDR2, RCV_BUILDINGNO, RCV_REQUEST,";
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<select name="rcv_tel1" id="rcv_tel1" class="formsel">
										...
										<option value="063"<%if(rcvTel1.equals("063")){out.print(" selected");}%>>063</option>
							...
							<tr>
								...
								<td colspan="3">
									...
									<input type="hidden" id="rcv_addr_bcode" name="rcv_addr_bcode" value="<%=rcvBuildingNo%>" />
								</td>
							</tr>
							<tr>
								<th>수령방법</th>
