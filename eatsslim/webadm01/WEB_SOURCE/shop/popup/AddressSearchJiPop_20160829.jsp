		...
		<div class="full_column">
			<div class="row">
				<ul class="smalltabNavi">				
					<li><a href="javascript:;" class="defaulttab" rel="tabs1">지번주소 검색</a></li>
					<li><a href="javascript:;" rel="tabs2">도로명주소 검색</a></li>				
				</ul>
				...
				if ($(this).text() == "success") {
					...
					$(data).find("address").each(function() {
						...
						if (zipcodeArr[0] == "nodata") {
							...
							text += '<tr id="zipTr'+trNum+'" style="cursor:pointer" onclick="fnSetAddrJi('+trNum+', \''+zipcodeArr[0]+'\', \''+addr1+'\', \'' + zipcodeArr[12] + '\', \'' + zipcodeArr[13] + '\', \'' + zipcodeArr[14] + '\')">';
