...
if (rs.next()) {
	...
	if (memZipcode != null && memZipcode.length() == 6) {
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td colspan="3">
									...
									<span class="button light small"><a href="javascript:;" onclick="newAddr('1');">우편번호 검색</a></span>
									<br />
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td colspan="3">
									...
									<span class="button light small"><a href="javascript:;" onclick="newAddr('2');">우편번호 검색</a></span>
									<br />
					...
					<div class="sectionHeader">
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<th>배송지 주소</th>
								<td colspan="3">
									<input name="tag_zipcode1" id="tag_zipcode1" type="text" class="ftfd" style="width:50px;" value="<%=memZipcode1%>" required label="우편번호" readonly maxlength="3" />
									-
                                    <input name="tag_zipcode2" id="tag_zipcode2" type="text" class="ftfd" style="width:50px;" value="<%=memZipcode2%>" required label="우편번호" readonly maxlength="3" />
									<span class="button light small"><a href="javascript:;" onclick="newAddr('2');">우편번호 검색</a></span>
									<br />
...
function myAddr() {
	...
	if ($("#devl_check").val() == "N") {
		...
		if (f.rcv_name) {
			...
			f.tag_zipcode1.value	= "<%=memZipcode1%>";
			f.tag_zipcode2.value	= "<%=memZipcode2%>";
...
function newAddr(str) {
	window.open('/shop/popup/oldAddress.jsp?ztype='+ str,'chk_zipcode','width=900,height=650,top=50,left=100,scrollbars=yes,resizable=no,toolbar=no,status=no,menubar=no');
}
</script>
</body>
</html>
