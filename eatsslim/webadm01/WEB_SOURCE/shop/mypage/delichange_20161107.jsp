		...
		<div class="row">
			<div class="one last  col">
				...
				<div class="line-box line-black">
					...
					<p>배송일 변경은 수령일로부터 D-3일 이후부터 <연기, 취소>에 대한 수정이 가능하시고, D-6일 이후부터는 <연기, 취소, 앞당기기> 등에 대한 모든 수정이 가능합니다 .</p>
					<p>주말 및 공휴일은 별도 배송이 이루어지지 않으며, 공휴일 배송 수량을 영업일 기준으로 기존 마지막 배송일 가장 뒷 날짜 뒤에 수령됩니다. </p>
				</div>
			</div>
		</div>
		<!-- End row --> 
