...
%>
						...
						<table class="inputfield" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<th>상담유형</th>
								<td>
									<select name="ecs_type1" id="ecs_type1" style="width:150px;" required label="상담유형1" onchange="readData(this,1);">
										<%=cateOpt1%>
									</select>
									<select name="ecs_type2" id="ecs_type2" style="width:150px;" required label="상담유형2" onchange="readData(this,2);">
										<option value="">==2차선택==</option>
									</select>
									<select name="ecs_type3" id="ecs_type3" style="width:150px;" required label="상담유형3">
