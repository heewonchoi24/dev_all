...
query		+= " ,DATEDIFF(MAX_DATE, NOW()) DATEDIF, OGG.ORDER_NUM, ODD.DELVCNT ";
query		+= " , case when ODD.SHOP_CD in ( '51' , '52', '59', '60' ) then";
query		+= "     DATE_FORMAT(DATE_ADD(MAX_DATE, INTERVAL -2 DAY), '%Y-%m-%d')";
query		+= "  else";
query		+= "   DATE_FORMAT(DATE_ADD(MAX_DATE, INTERVAL -3 DAY), '%Y-%m-%d') ";
...
query		+= " ) OGG, (";
query		+= " SELECT GOODS_ID, ORDER_NUM, RCV_HP, MAX(DEVL_DATE) MAX_DATE, SHOP_CD, COUNT(ID) AS DELVCNT FROM ESL_ORDER_DEVL_DATE";
...
query		+= " HAVING DATEDIFF(MAX_DATE, NOW()) in ( 4, 3, 0 ) ";
...
while (rs.next()) {
	...
	if (rcvHp.equals("010-9444-8585") || rcvHp.equals("010-7197-1346")) {
		...
		if (dateDif.equals("0")) {
			...
			} else if ( shopCd.equals("59") || shopCd.equals("60") ) {
				if (dateDif.equals("3")) {
					sendYn			= "Y";
					sendType		= "05";
				}
		...
		if (sendYn.equals("Y")) {
			...
			if (sendType.equals("01")) {
				...
				query1		+= " ,'[풀무원잇슬림] 배송종료안내'";
				query1		+= " ,'[풀무원잇슬림] 잇슬림을 연속해서 배송 받을수 있는 주문일이 오늘까지 입니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문 : " + newDate + "까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문생산 방식으로 생산됩니다.\r※ 연속배송을 원하시면 꼭 오늘까지 주문해 주세요.\rhttp://www.eatsslim.co.kr'";				
			} else if (sendType.equals("04")) {
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + " PM 3시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.'";
				query1		+= ",'eat15'";
				query1		+= " ,'[풀무원잇슬림] 배송종료안내'";
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + "  PM 3시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.\rhttp://www.eatsslim.co.kr'";				
			} else if (sendType.equals("05")) {
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + " 11시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.'";
				query1		+= ",'eat15'";
				query1		+= " ,'[풀무원잇슬림] 배송종료안내'";
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + "  11시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.\rhttp://www.eatsslim.co.kr'";				
			} else if (sendType.equals("06")) {
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + " 24시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.'";
				query1		+= ",'eat15'";
				query1		+= " ,'[풀무원잇슬림] 배송종료안내'";
				query1		+= " ,'[풀무원잇슬림] 다음 주문 시 계속해서 배송 받을수 있는 연속 배송 가능 주문일자를 안내드립니다.\r\r▶ 주문제품 : "+ productName +"\r▶ 배송종료일 : "+ endDate +"\r▶ 연속배송가능주문일 : " + newDate + "  24시까지\r\r※ 잇슬림은 신선한 원료 수급과 검증을 위해 주문 생산 방식으로 생산됩니다.\r※ 연속배송 가능주문일까지 주문하시면 중단 없이 배송 받으실 수 있습니다.\rhttp://www.eatsslim.co.kr'";				
			} else {
