...
String rcvBuildingNo	= ut.inject(request.getParameter("rcv_addr_bcode"));
...
if(orderEnv.equals("M")){ //모바일주문일 경우
	if (request.getRequestURI().indexOf("/mobile2") >= 0) {
		returnURL="parent.location.href='/mobile2/shop/payment.jsp?ono="+orderNum+"'";
	} else {
...
int i = 0;
%>
<%@ include file="/lib/phi_insert_free.jsp"%>
<%
