...
//상품명
query1		= "SELECT GROUP_ID, GROUP_NAME, RCV_HP, DEVL_DATE, DEVL_TYPE, PAY_TYPE, DEVL_FIRST_DAY, EXP_PROMOTION";
...
if (payType.equals("30")) { //가상계좌는 주문접수로
	...
	if(rcvHp != null && !"".equals(rcvHp)){
		...
		if("U".equals(snsLogin)){ //-- 통합로그인
			...
			query		+= " ) VALUES (";
			query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
			query		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다.\r▶ 주문제품 : "+ productName + "\r▶ 배송기간 : " + minDate22 + "~" +maxDate + "\r\r※ 주문 조회/ 배송 일정/ 배송지 변경은 아래 링크된 고객기쁨센터 또는 잇슬림 홈페이지에서 가능합니다.'";
			query		+= " ,'[풀무원잇슬림] 배송안내'";
			query		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다.\r▶ 주문제품 : "+ productName + "\r▶ 배송기간 : " + minDate22 + "~" +maxDate + "\r\r※ 주문 조회/ 배송 일정/ 배송지 변경은 아래 링크된 고객기쁨센터 또는 잇슬림 홈페이지에서 가능합니다.\rhttp://www.eatsslim.co.kr'";
			query		+= " ,'001','002','004','"+rcvHp+"'";
			...
			if(devlType1Count > 0){
				...
				query		+= " ) VALUES (";
				query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
				query		+= " ,'[풀무원잇슬림]\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : "+ productName + "\r▶ 배송기간 : " + minDate22 + "~" +maxDate + "\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지를 통해 이용가능합니다.\r→ 잇슬림 홈페이지 > 마이페이지 > 주문조회/변경'";
				query		+= " ,'[풀무원잇슬림] 배송안내'";
				query		+= " ,'[풀무원잇슬림]\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : "+ productName + "\r▶ 배송기간 : " + minDate22 + "~" +maxDate + "\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지를 통해 이용가능합니다.\r→ 잇슬림 홈페이지 > 마이페이지 > 주문조회/변경'";
				query		+= " ,'001','002','004','"+rcvHp+"'";
				...
				query		+= " ) VALUES (";
				query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
				query		+= " ,'[풀무원잇슬림]\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : "+ productName + "\r▶배송기간 : " + minDate22 + "~" +maxDate + "\r배송일은 주말, 공휴일, 택배사 사정 등에 따라 일부 지연될 수 있습니다.\r\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'[풀무원잇슬림] 배송안내'";
				query		+= " ,'[풀무원잇슬림]\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : "+ productName + "\r▶배송기간 : " + minDate22 + "~" +maxDate + "\r배송일은 주말, 공휴일, 택배사 사정 등에 따라 일부 지연될 수 있습니다.\r\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'001','002','004','"+rcvHp+"'";
