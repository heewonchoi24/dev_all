...
if (payType.equals("30")) { //가상계좌는 주문접수로
	...
	if(rcvHp != null && !"".equals(rcvHp)){
		...
		if("U".equals(snsLogin)){ //-- 통합로그인
			...
			query		+= " ) VALUES (";
			query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
			query		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다. 주문하신 잇슬림 \""+ productName + "\"이 \"" + minDate + "~" +maxDate + "\" 동안 배달 예정입니다.\r\r- 이달의 식단 안내 : http://www.eatsslim.co.kr/mobile/intro/schedule.jsp\r- 상세 주문 조회 및 배송 일정/배송지 변경 등을 원하실 경우 아래 링크된 풀무원고객기쁨센터를 통해 조정 가능하십니다. 감사합니다.'";
			query		+= " ,'[풀무원잇슬림] 배송안내'";
			query		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다. \""+ productName + "\" \"" + minDate + "~" +maxDate + "\"동안 배달 예정입니다. 식단 안내 : 잇슬림 이달의 식단 스케쥴 URL 안내 ( http://www.eatsslim.co.kr/mobile/intro/schedule.jsp ) 배송일 변경은 받으시는 날 3일전까지 잇슬림 홈페이지 \"마이페이지>주문/배송>배송일자변경\" 또는 1:1문의하기 통하여 가능합니다. 감사합니다.'";
			query		+= " ,'001','002','004','"+rcvHp+"'";
			...
			if(devlType1Count > 0){
				...
				query		+= " ) VALUES (";
				query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
				query		+= " ,'[풀무원 잇슬림]\r\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : \""+ productName + "\"\r\r▶ 배송기간 : \"" + minDate + "~" +maxDate + "\"\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'[풀무원잇슬림] 배송안내'";
				query		+= " ,'[풀무원 잇슬림]\r\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : \""+ productName + "\"\r\r▶ 배송기간 : \"" + minDate + "~" +maxDate + "\"\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'001','002','004','"+rcvHp+"'";
				query		+= " ,'02-6411-8322','R00',SYSDATE,'eat6',SYSDATE";
				...
				query		+= " ) VALUES (";
				query		+= " CUST_DELV_ALL.TSMS_MESSAGE_SEQ.nextval ,'1710002662'";
				query		+= " ,'[풀무원 잇슬림]\r\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : \""+ productName + "\"\r\r▶배송일 : \"" + minDate + "\"\r\r배송일은 주말, 공휴일, 택배사 사정 등에 따라 일부 지연될 수 있습니다.\r\r\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'[풀무원잇슬림] 배송안내'";
				query		+= " ,'[풀무원 잇슬림]\r\r잇슬림 주문이 완료되었습니다.\r\r▶ 주문제품 : \""+ productName + "\"\r\r▶배송일 : \"" + minDate + "\"\r\r배송일은 주말, 공휴일, 택배사 사정 등에 따라 일부 지연될 수 있습니다.\r\r\r\r※ 주문조회/ 배송 일정/ 배송지 변경은 잇슬림 홈페이지(www.eatsslim.co.kr) 에서 가능합니다.'";
				query		+= " ,'001','002','004','"+rcvHp+"'";
				query		+= " ,'02-6411-8322','R00',SYSDATE,'eat6',SYSDATE";
