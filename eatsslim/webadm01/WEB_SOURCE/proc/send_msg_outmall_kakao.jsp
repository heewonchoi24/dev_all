...
while (rs.next()) {
	...
	query1		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다. 주문하신 잇슬림 \""+ productName + "\"이 \"" + minDate + "~" +maxDate + "\" 동안 배달 예정입니다.\r\r- 이달의 식단 안내 : http://www.eatsslim.co.kr/mobile/intro/schedule.jsp\r- 주문 조회 및 배송 일정/배송지 변경 등을 원하실 경우 풀무원고객기쁨센터를 통해 아래 외부몰 주문번호 입력 후 조정 가능하십니다. 감사합니다. (풀무원고객기쁨센터 > 외부몰 주문조회)\r*풀무원샵 잇슬림 주문 건은, 잇슬림 자사몰과 다르므로 꼭 외부몰 주문조회를 이용해주세요.\r주문번호 : "+outOrderNum+"'";
	query1		+= " ,'[풀무원잇슬림] 배송안내'";
	...
	query1		+= " ,'[풀무원잇슬림] 잇슬림 주문이 완료되었습니다. 주문하신 잇슬림 \""+ productName + "\"이 \"" + minDate + "~" +maxDate + "\" 동안 배달 예정입니다.\r\r- 이달의 식단 안내 : http://www.eatsslim.co.kr/mobile/intro/schedule.jsp\r- 주문 조회 및 배송 일정/배송지 변경 등을 원하실 경우 풀무원고객기쁨센터를 통해 아래 외부몰 주문번호 입력 후 조정 가능하십니다. 감사합니다. (풀무원고객기쁨센터 > 외부몰 주문조회)\r주문번호 : "+outOrderNum+"'\r* 풀무원 잇슬림 카카오톡을 통해 주문정보 확인 및 이달의 식단 확인이 가능합니다. 감사합니다^^";
	query1		+= " ,'[풀무원잇슬림] 배송안내'";
	query1		+= " ,'[풀무원잇슬림] 잇슬림 \""+ productName + "\" \"" + minDate + "~" +maxDate + "\"동안 배달 예정입니다. 식단 안내 : 잇슬림 이달의 식단 스케쥴 URL 안내 ( http://www.eatsslim.co.kr/mobile/intro/schedule.jsp ) 배송일 변경은 받으시는 날 3일전까지 잇슬림 홈페이지( www.eatsslim.co.kr )를 통하여 가능하시며, 기타 문의사항은 고객센터(02-6411-8322) 또는 문의 게시판을 통해 남겨주세요. 감사합니다.'";
	query1		+= ",'001','002','004','"+rcvHp+"'";
