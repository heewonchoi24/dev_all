		...
		<div class="sixteen columns offset-by-one">
			...
			<div class="row">
					<ul class="foodmonthtab floatleft">
						<li<%if (categoryCode.equals("0301368") || categoryCode.equals("0301368")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0301368">500 차림</a></li>
						<li<%if (categoryCode.equals("0300584") || categoryCode.equals("0300700")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0300584">400 슬림식</a></li>
						<li<%if (categoryCode.equals("0300586") || categoryCode.equals("0300702")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0300586">300 샐러드</a></li>
						<li<%if (categoryCode.equals("0300965")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0300965">300 덮밥</a></li>
						<li<%if (categoryCode.equals("0301590")) out.println(" class=\"current\"");%>><a href="foodmonthplan.jsp?ccode=0301590">미니밀</a></li>
					</ul>
			</div>
			...
			이후 식단은 기존 400 슬림식 식단 스케줄대로 배송되며, 주문일로부터 첫 배송일이 6일 후인 경우는, 기존 400 슬림식 식단 스케줄대로 배송됩니다.</p>
			</div>
			<% } %> -->
			<!-- End row -->
			<div class="row">
							...
							<div class="fc-view fc-view-month fc-grid" style="position: relative; -moz-user-select: none;" unselectable="on">
								<table class="fc-border-separate" cellspacing="0" style="width:100%">
									<thead>
										...
										<th class="fc-day-header fc-sun fc-widget-header fc-first" style="width: 152px;">일(Sun)</th>
										<th class="fc-day-header fc-mon fc-widget-header" style="width: 152px;">월(Mon)</th>
										<th class="fc-day-header fc-tue fc-widget-header" style="width: 152px;">화(Tue)</th>
										<th class="fc-day-header fc-wed fc-widget-header" style="width: 152px;">수(Wed)</th>
										<th class="fc-day-header fc-thu fc-widget-header" style="width: 152px;">목(Thu)</th>
										<th class="fc-day-header fc-fri fc-widget-header" style="width: 152px;">금(Fri)</th>
										<th class="fc-day-header fc-sat fc-widget-header fc-last" style="width: 152px;">토(Sat)</th>
										</tr>
									</thead>
									<tbody>
									<%
									...
									%>
										<td class="fc-day fc-mon fc-widget-content fc-past<%if (newLine == 6) out.println(" fc-last");%>" data-date="<%=nowDate%>">
											...
											<a class="lightbox" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=645&set_id=<%=setId%>">
												<div>
													<div class="fc-day-number"><%=i%><%if (categoryCode.equals("0301590") && (newLine == 0 || newLine == 6)) out.println(" <strong>금요일 함께 배송</strong>");%></div>
		...
		<div class="clear"></div>
			...
			<div class="row">
				<div class="foodmonthNotice">
					<div class="em">※ 잇슬림 주문마감일 D-3 15시</div>
					<p>: 주문이 급증 할 경우, 조기 마감되어 첫 배송일이 주문일로부터 4~6일 뒤로 변경 될 수 있습니다.</p>
					<div class="em">※ 계절메뉴, 신메뉴 출시 등의 이슈에 따라 일부 메뉴가 식단표와 상이할 수 있습니다.</div>
					<div class="em">※ 미니밀 일일배달 제품은 '주말 옵션'을 선택하셨을 경우, 토요일 식단이 금요일에 함께 제공됩니다.</div>
				</div>
			</div>
