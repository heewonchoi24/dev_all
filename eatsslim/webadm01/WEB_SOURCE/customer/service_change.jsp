                  ...
                  <dd>
                      <ul class="bubblelist">
                          ...
                          <li>
							  ...
							  그 외 접수일 기준 1~2일 후 제품은 이미 주문 및 생산 작업이 진행되고 있어, 별도 취소/환불 등이 불가한 점 양해부탁드립니다. </p>
                              <div class="bg-gray mart10 marb10" style="padding:15px;">
                                  <h5>· 잇슬림 홈페이지에서 주문한 경우</h5>
                                  <p>
                                  1) PC: 로그인 > 마이페이지 > '배송캘린더' 버튼을 클릭하여 직접 변경해주세요.<br />
								  2) Mobile : 로그인 > '주문조회변경' 버튼을 클릭하여 직접 변경해주세요.<br />
                                  3) 고객기쁨센터(080-800-0434) 또는 1:1상담 게시판을 통해 문의해주세요.
                                  </p>
                                  <div class="divider"></div>
                                  <h5>· 외부몰에서 주문한 경우</h5>
                                  <p>
                                  고객기쁨센터(080-800-0434) 또는 1:1상담 게시판을 통해 문의해주세요.
                                  </p>
                              </div>
                          </li>
                      </ul>
