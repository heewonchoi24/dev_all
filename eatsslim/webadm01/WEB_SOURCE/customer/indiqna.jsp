...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<div class="pageDepth">
				<span>HOME</span><span>고객센터</span><strong>1:1문의</strong>
			</div>
			<div class="clear"></div>
		</div>
				...
				<div class="threefourth last col">
					<div class="guide qnaImg">
						<ul>
							...
							<li><strong class="font-blue">공휴일</strong>(임시공휴일, 법정공휴일 포함)은 <strong class="font-blue">영업휴무일</strong>인 관계로, 다음 날 신속하게 답변드리도록 하겠습니다.</li>
						</ul>
					</div>
				</div>
			</div>
			...
			if ($(this).text() == "success") {
				...
				$(data).find("group").each(function() {
					...
					for (i=0;i<groupArr.length-1;i++){
						...
						typeOptions	+= "<option value='"+arrTmp[0]+"'>"+arrTmp[1]+"</option>";
