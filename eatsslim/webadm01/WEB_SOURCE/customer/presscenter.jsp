...
int divNum			= 0;
String divClass		= "";
String iPageTmp		= ut.inject(request.getParameter("page"));
String pgsizeTmp	= ut.inject(request.getParameter("pgsize"));
...
if (!ut.isNaN(iPageTmp)) {
	iPage		= 1;
	startpage	= 1;
} else if (iPageTmp != null && iPageTmp.length()>0){
...
if (!ut.isNaN(pgsizeTmp)) {
	pgsize		= 1;
} else if (pgsizeTmp != null && pgsizeTmp.length()>0)
	pgsize		= Integer.parseInt(pgsizeTmp);
...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<div class="pageDepth">
				<span>HOME</span><span>고객센터</span><strong>언론보도</strong>
			</div>
			<div class="clear"></div>
		</div>
