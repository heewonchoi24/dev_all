  ...
  <div class="container">
    ...
    <div class="twelve columns offset-by-one ">
      ...
      <div class="row" style="margin-bottom:40px;">
        <div class="threefourth last col">
          <ul class="listSort">
            ...
            <li> <a href="/customer/service_coupon.jsp">쿠폰안내</a> </li>
		    <li><a href="/customer/service_partnership.jsp">제휴안내</a></li>
          </ul>
        </div>
      </div>
      <!-- End row -->
      <div class="row">
        <div class="threefourth last col">
		<!--
          <div class="marb50"><img src="/images/serimg_04_01.png" width="100%"></div> -->
          <dl class="regist">
            <dt>
              <h2>주문취소</h2>
            </dt>
            <dd>
              <ul class="bubblelist">
                ...
                <li> <span class="bubble">02</span>
                  ...
                  <p>주문취소는 <span class="txtline">로그인 > 마이페이지 > 주문내역조회 > 주문/배송조회</span>에서 신청하시거나  고객센터 1:1상담 또는 고객기쁨센터 080-800-0434로 내용을 알려주시면 신속하게 처리해 드리겠습니다.</p>
                </li>
          ...
          <dl class="regist">
            ...
            <dd>
              ...
              <p class="mart10">주문교환 및 반품은 <span class="txtline">로그인 > 마이페이지 > 주문내역조회 > 취소/교환/반품조회</span> 에서 신청하시거나 고객센터 1:1상담<br />
