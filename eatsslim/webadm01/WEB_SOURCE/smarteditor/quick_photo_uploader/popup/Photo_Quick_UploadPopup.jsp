...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="file_uploader.jsp?editor_id=<%=editor_id%>" method="post" enctype="multipart/form-data">
        <div id="pop_content2">
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
    	<!-- content -->
		<form id="editor_upimage5" name="editor_upimage5" action="file_uploader.jsp?editor_id=<%=editor_id%>" method="post" enctype="multipart/form-data">
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="Filedata">
            <p class="dsc" id="info"><strong>10MB</strong>이하의 이미지 파일만 등록할 수 있습니다.<br>(JPG, GIF, PNG, BMP)</p>
        </div>
