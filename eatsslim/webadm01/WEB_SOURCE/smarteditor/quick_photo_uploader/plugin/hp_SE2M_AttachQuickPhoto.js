...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	 ...
	 * 포토 웹탑 오픈
	 */
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(id){	
		
		this.htPopupOption.sUrl = this.makePopupURL(this.oApp.elPlaceHolder.id);
	 ...
	 */
	makePopupURL : function(id){
		var sPopupUrl = "/smarteditor/quick_photo_uploader/popup/Photo_Quick_UploadPopup.jsp?editor_id="+id; 
