...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			...
			<div class="pageDepth">
				<span>HOME</span><span>배달안내</span><strong>극신선 일일배달</strong>
			</div>
			<div class="eventList_tabmenu">
				<ul>
					...
					<li class="active"><a href="/delivery/freshparcel.jsp">극신선 일일배달</a></li>
				</ul>
			</div>
			<div class="clear">
			</div>
		...
		<div class="sixteen columns offset-by-one">
			<div class="row">
			    <div class="one last  col">
				     <div><img src="/images/delivery_top04.jpg" width="1100" height="281" alt="극신선 일일배달"></div>
				</div>
			</div>
			<!-- End Row -->
			    ...
			    <div class="one last  col">
				   <div class="sectionHeader">
                     ...
                     <ul class="delistep">
                       ...
                       <li class="darow"><img src="/images/delistep_arrow.png" width="94" height="58"></li>
                       <li><img src="/images/delistep_03.png" width="144" height="144"><p><strong class="font-blue">[제품생산+2일]</strong><br/>고객님 가정<br /><span>(밤12시~아침7시)</span></p></li>
                     <div class="clear"></div>
                     </ul>
            ...
            <div class="row">
			    <div class="one last  col">
                     ...
                     <p>일일배달의 경우 식재료 구매부터 배달까지 3일이 소요되며, 주문일 기준 3일(주말, 공휴일 제외한 평일 기준) 후부터 첫 배달일 선택이 가능합니다.<br />
                     선택한 첫 배달일에 잇슬림 제품이 배달됩니다.</p>
                     <div class="divider"></div>
                     <h3>배달 시간</h3>
                     <p>밤 12시부터 아침 7시 사이에 이루어 집니다.<br />악천 후,교통상황,배달물량의 급격한 증가,고객님의 요청 등의 상황에 따라 정해진 배달 시간에서 1시간 정도 조기,연장 배달될 수 있습니다. </p>
                     <div class="divider"></div>
                     <h3>수령방법</h3>
