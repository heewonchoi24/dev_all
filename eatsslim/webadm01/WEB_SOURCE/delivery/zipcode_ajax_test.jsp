...
if (mode.equals("post")) {
	if (schDong == null || schDong.equals("")) {
		...
		try {
			query		= "SELECT ZIPCODE, SIDO, GUGUN, DONG, BUNJI, DLVTYPE, DLVPTNCD FROM PHIBABY."+ table;
