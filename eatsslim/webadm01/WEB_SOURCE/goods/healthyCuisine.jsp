				...
				<div class="one last col">
					...
					<div class="foodlist">
						...
						<div class="food<%=divClass%>">
							<div>
								<a class="food-thumb2 lightbox" rel="group1" href="/shop/cuisineinfo/cuisineA.jsp?lightbox[width]=780&lightbox[height]=550&set_id=<%=setId%>" title="<%=setName%>"><img src="<%=imgUrl%>" alt="<%=setName%>" />
								<div class="food-link">
					...
					<!-- End 퀴진 리스트 -->
					<p class="mart10 marb10">* 잇슬림에서는 불필요한 일회용품 사용을 줄이고, 다이어트 식습관을 길들이기 위해서 <strong>젓가락만 제공</strong>됩니다.</p>
				</div>
			</div>
			<!-- End Row -->
			<div class="row">
