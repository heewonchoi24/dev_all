...
var _TRK_PNG = "간편식";
var _TRK_PNG_NM = "03";
var _TRK_PNC = "0300578";
var _TRK_PNC_NM = "밸런스쉐이크";
</SCRIPT>
            ...
            <div class="row">
                ...
                <table class="centralKitchen" width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <p>- 섭취량은 성인 기준으로 표시되어 있으며, 섭취자의 연령이나 신체 상태에 따라 제품섭취량 조절이 가능합니다.</p>
					<p>- 가르시니아캄보지아와 카테킨 성분이 소량 함유되어 있어 임산부나 수유부 여성에게는 권장하지 않습니다.</p></td>
                  </tr>
                  <tr>
