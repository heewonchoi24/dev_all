...
<div id="wrap">
	...
	<div class="container">
		<div class="maintitle">
			<h1>이용약관</h1>
			<div class="pageDepth">
				<span>HOME</span><strong>이용약관</strong>
			</div>
			<div class="clear"></div>
		</div>
				...
				<div class="one last col">
					<div class="termsbox">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td><a href="#terms01">제1조 목적</a></td>
								<td><a href="#terms02">제2조 약관 등의 명시와 설명 및 개정</a></td>
								<td><a href="#terms03">제3조 회원가입</a></td>
								<td><a href="#terms04">제4조 서비스의 제공 및 변경</a></td>
							</tr>
							<tr>
								<td><a href="#terms05">제5조 서비스의 중단</a></td>
								<td><a href="#terms06">제6조 회원가입</a></td>
								<td><a href="#terms07">제7조 회원 탈퇴 및 자격 상실 등</a></td>
								<td><a href="#terms08">제8조 회원에 대한 통지</a></td>
							</tr>
							<tr>
								<td><a href="#terms09">제9조 구매신청</a></td>
								<td><a href="#terms10">제10조 계약의 성립</a></td>
								<td><a href="#terms11">제11조 지급방법</a></td>
								<td><a href="#terms12">제12조 수신확인통지, 구매신청 변경 및 취소</a></td>
							</tr>
							<tr>
								<td><a href="#terms13">제13조 재화 등의 공급</a></td>
								<td><a href="#terms14">제14조 포인트 또는 적립금 제도의 운영</a></td>
								<td><a href="#terms15">제15조 환금</a></td>
								<td><a href="#terms16">제16조 청약철회 등</a></td>
							</tr>
							<tr>
								<td><a href="#terms17">제17조 청약철회 등의 효과</a></td>
								<td><a href="#terms18">제18조 개인정보보호</a></td>
								<td><a href="#terms19">제19조 ‘몰’의 의무</a></td>
								<td><a href="#terms20">제20조 회원의 ID 및 비밀번호에 대한 의무</a></td>
							</tr>
							<tr>
								<td><a href="#terms21">제21조 이용자의 의무</a></td>
								<td><a href="#terms22">제22조 연결 ‘몰’과 피연결 ‘몰’간의 관계</a></td>
								<td><a href="#terms23">제23조 저작권의 귀속 및 이용제한</a></td>
								<td><a href="#terms24">제24조 분쟁해결</a></td>
							</tr>
							<tr>
								<td><a href="#terms25">제25조 재판권 및 준거법</a></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
					...
					<h4 id="terms01">제1조 목적</h4>
					<p>
						이 약관은 (주)풀무원녹즙(이하, ‘회사’)이 운영하는 [풀무원건강생활, 풀무원그린체, 녹즙, 베이비밀, 잇슬림]에서 제공하는 인터넷 관련 서비스(이하, ‘서비스’라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
					</p>
					<div class="divider"></div>
					<h4 id="terms02">제2조 정의</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms03">제3조 약관 등의 명시와 설명 및 개정</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms04">제4조 서비스의 제공 및 변경</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms07">제7조 탈퇴 및 자격 상실 등</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms14">제14조 포인트 또는 적립금 제도의 운영</h4>
					<p>
						...
						⑥ 이용 해지와 동시에 적립된 적립금은 소멸되며 재가입 하여도 한 번 소멸된 적립금은 다시 적용되지 않습니다.
					</p>
					<div class="divider"></div>
					<h4 id="terms15">제15조 환금</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms17">제17조 청약철회 등의 효과</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms20">제20조 회원의 ID 및 비밀번호에 대한 의무</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms22">제22조 연결 ‘몰’과 피연결 ‘몰’간의 관계</h4>
					<p>
						① ‘몰’은 다른 사이트를 하이퍼링크(하이퍼링크의 대상에는 문자, 그림 및 동영상 등이 포함)방식 등에 의해 연결시킬 수 있습니다.<br />
						② ‘몰’은 이용자가 해당 연결된 다른 사이트와 독자적으로 상품 또는 용역을 거래한 행위에 대하여는 어떠한 책임도 부담하지 않습니다.
					</p>
					<div class="divider"></div>
					<h4 id="terms23">제23조 저작권의 귀속 및 이용제한</h4>
					<p>
					...
					<div class="divider"></div>
					<h4 id="terms25">제25조 재판권 및 준거법</h4>
					<p>
						① '몰'과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 소제기 상대방 소재지를 관할하는 법원을 제1심 관할법원으로 한다.<br />
						② ‘몰’과 이용자 간에 제기된 전자상거래 소송에는 대한민국 법을 적용합니다.
					</p>
				</div>
			</div> <!-- End Row -->
