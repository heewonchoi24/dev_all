...
request.setCharacterEncoding("euc-kr");
     ...
     */
    String CST_PLATFORM         = request.getParameter("CST_PLATFORM");                 //LG유플러스 결제서비스 선택(test:테스트, test:서비스)
    ...
    String LGD_MERTKEY          = "800d045bf303efacd762f30749919b62";              		//상점MertKey(mertkey는 상점관리자 -> 계약정보 -> 상점정보관리에서 확인하실수 있습니다)
     ...
     */
    String LGD_CASNOTEURL		= "http://210.180.115.139/mobile/xpayMobile/cas_noteurl.jsp";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    String LGD_RETURNURL		= "http://210.180.115.139/mobile/xpayMobile/returnurl.jsp";// FOR MANUAL

    /*
     * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다.
     */
    String LGD_KVPMISPNOTEURL       = "http://210.180.115.139/mobile/xpayMobile/note_url.jsp";
    String LGD_KVPMISPWAPURL		= "http://210.180.115.139/mobile/xpayMobile/mispwapurl.jsp?LGD_OID=" + LGD_OID;  //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
    String LGD_KVPMISPCANCELURL     = "http://210.180.115.139/mobile/xpayMobile/cancel_url.jsp";
