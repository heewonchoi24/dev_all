...
request.setCharacterEncoding("euc-kr");
     ...
     */
    String LGD_CASNOTEURL		= "http://p.tmap4.com/mobile/xpayMobile/cas_noteurl.jsp";

    /*
     * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
     */
    String LGD_RETURNURL		= "http://p.tmap4.com/mobile/xpayMobile/returnurl.jsp";// FOR MANUAL

    /*
     * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다.
     */
    String LGD_KVPMISPNOTEURL       = "http://p.tmap4.com/mobile/xpayMobile/note_url.jsp";
    String LGD_KVPMISPWAPURL		= "http://p.tmap4.com/mobile/xpayMobile/mispwapurl.jsp?LGD_OID=" + LGD_OID;  //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
    String LGD_KVPMISPCANCELURL     = "http://p.tmap4.com/mobile/xpayMobile/cancel_url.jsp";
