...
$(document).ready(function(e) {
    $('#image_section_m[usemap]').rwdImageMaps();
});
</script>
        ...
        <h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">이벤트</span></span></h1>
            <div class="row">
                <div class="event">
					...
					%>
					<div class="imgArea" id="imgArea_p" style="text-align: center;">
						<img id="image_section_m" name="image_section_m" style="width: 100%; max-width: 1000px;" src="<%=webUploadDir +"promotion/"+ content%>" alt="잇슬림이벤트" border="0" usemap="#tabMap" />
					</div>
					...
					<%} if(!imgMapLocal_m6.equals("") && !link_num_m6.equals("")){%>
						<area shape="rect" coords="<%=imgMapLocal_m6%>" target="_self" onclick="location.href='<%=link_num_m6%>'" />
					<%} if(!imgMapLocal_m7.equals("") && !link_num_m7.equals("")){%>
