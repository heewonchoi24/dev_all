    ...
    <div id="content" class="oldClass">
		...
		<div class="grid-navi">
			<table class="navi" border="0" cellspacing="10" cellpadding="0">
				<tr>
					<td><a href="/mobile/event/index.jsp" class="ui-btn ui-btn-inline ui-btn-up-f"><span class="ui-btn-inner"><span class="ui-btn-text">진행중인 이벤트</span></span><span class="active"></span></a></td>
					<td><a href="/mobile/event/indexLast.jsp" class="ui-btn ui-btn-inline ui-btn-up-f-line"><span class="ui-btn-inner"><span class="ui-btn-text">지난 이벤트</span></span></a></td>
				</tr>
			</table>
		</div>
            <div class="row">
