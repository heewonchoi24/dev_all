...
<aside id="cart">
	<%
		String ftCartNoDisplayUrl = "/mobile/shop/cart.jsp|/mobile/shop/order.jsp|/mobile/shop/payment.jsp";
		if (ftCartNoDisplayUrl.indexOf(request.getRequestURI()) == -1) {
	%>
	<%@ include file="/mobile/common/include/inc-cart.jsp"%>
	<%
		}
	%>
</aside>
<footer id="footer">
	<section class="footer_top">
		<div class="inner">
			<ul class="footer_list">
				...
				<li><a
					href="http://www.ftc.go.kr/info/bizinfo/communicationViewPopup.jsp?wrkr_no=3018198406&amp;lightbox[width]=808&amp;lightbox[height]=740&amp;lightbox[iframe]=true"
					class="lightbox">사업자정보확인</a></li>
	...
	<section class="footer_bottom">
		<div class="inner container">
			<img src="/mobile/common/images/footer_area1.jpg" alt="풀무원건강생활 BI">
			<p
				style="font-size: 1.25rem; padding-bottom: 3rem; line-height: 2rem;">
				풀무원녹즙 : 충청북도 증평군 도안면 원명로 35<br /> 대표이사 : 김기석 | 사업자등록번호 :
				301-81-98406<br /> 개인정보관리책임자 : 장종의 담당 | 통신판매업신고번호 : 충북증평 00045<br />
				CopyrightⓒPulmuone Health&Living Co., Ltd. All rights reserved.<br />
				<a href="tel:080-800-0434" style="color: #fff;">☎ 고객기쁨센터 :
					080-800-0434</a>
			</p>
			<!--	<img src="/mobile/common/images/footer_area.jpg" alt=""> -->
		</div>
	</section>
</footer>
<section id="pop_bx_common"></section>
<section id="bg_left_menu"></section>
<script>
	        cartFn.onInit();

	        function atcButton(groupId){
	        	var $atcBtn = $("#shop_content .addtocart");

	        	$(window).load(function(){
	        		TweenMax.to($atcBtn, 0.3, {css:{scale:1, opacity:1}, ease:Back.easeOut.config(3)});
	        	});
	        	$atcBtn.on("click", function(e){
	        		var $ripples = $atcBtn.find("span");
	        		$ripples.addClass('ripple-effect');
...
//	        		var tl = new TimelineMax();
	        		window.calendarPop = new CalendarPopFn({url:'/mobile/shop/order/__ajax_goods_set_options.jsp?groupId='+groupId+''});

	        		return false;
	        	});
	        }

	     	$("#cboxClose").on('click','cbox_closed',function(e){
	     		$.colorbox.close()
	     	});
		</script>
...
<noscript>
	<img
		src='http://gmb.acecounter.com/mwg/?mid=AZ1A61525&tp=noscript&ce=0&'
		border=0 width=0 height=0>
</noscript>
<!-- AceCounter Mobile Gathering Script End -->
<!-- ADWorks Common Script START -->
<script language="javascript">try{var _adws_un='1813';_adws_ckDmYn='Y';_adws_ver='22';_adws_src=location.protocol=="https:"?"https://"+"adws2.opms.co.kr/":"http://"+"js.adws.opms.co.kr/";_adws_src+="script/"+_adws_ver+"/"+"adworks.js";if((typeof _ADWS_CNT_)!='number'){var _ADWS_CNT_=0;};if(_ADWS_CNT_==0){_ADWS_CNT_++;eval("try{_vu=top.document.location.href;}catch(_e){_vu ='';};");eval("try{_svu=self.document.location.href;}catch(_e){_svu ='';};");if((_vu.indexOf("_OPMS_CK=")>-1&&_vu.indexOf("_OPMS_VID=")>-1&&_vu==_svu)||((typeof _OPMS_AN)!="undefined"&&_OPMS_AN!=""&&(typeof _OPMS_PN)!="undefined"&&_OPMS_PN!=""&&document.cookie.indexOf("_OPMS_LD_TID===")>-1)||((typeof _adws_dcTgYn)!="undefined"||_adws_dcTgYn!="")){document.write('<scr'+'ipt language="javascript" src="'+_adws_src+'"></scr'+'ipt>');};};}catch(e){}</script>
...
<script language='JavaScript1.1'
	src='//pixel.mathtag.com/event/js?mt_id=934430&mt_adid=158356&v1=&v2=&v3=&s1=&s2=&s3='></script>

<!-- N2S 스크립트 광고  수집용 Start 2016.06.24 -->
<script language="javascript"
	src="//web.n2s.co.kr/js/_n2s_sp_log_ecmdmkt_m.js"></script>
<!-- N2S 스크립트 광고  수집용 End -->
...
<script
	src="https://cdn.megadata.co.kr/js/en_script/3.5/enliple_sns_min3.5.js"
...
<noscript>
	<div style="display: inline;">
		<img height="1" width="1" style="border-style: none;" alt=""
			src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/850532697/?guid=ON&amp;script=0" />
	</div>
</noscript>
...
<script type="text/javascript"
	src="//static.tagmanager.toast.com/tag/view/880"></script>
<script type="text/javascript">
