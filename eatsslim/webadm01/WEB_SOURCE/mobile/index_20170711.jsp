	...
	<div id="main_container">
		...
		<div class="visual_area">
			<div class="main_visual">
				<!-- <div class="visual_item"><a href="/mobile/event/view.jsp?id=315&pgsize=10"><img src="/mobile/common/images/m_main_visual6.jpg" alt=""></a></div> -->
				<div class="visual_item"><a href="/mobile/event/view.jsp?id=311&pgsize=10"><img src="/mobile/common/images/m_main_visual1.jpg" alt=""></a></div>
				<div class="visual_item"><a href="/mobile/event/view.jsp?id=312&pgsize=10"><img src="/mobile/common/images/m_main_visual2.jpg" alt=""></a></div>
				<div class="visual_item"><a href="/mobile/event/view.jsp?id=314&pgsize=10"><img src="/mobile/common/images/m_main_visual3.jpg" alt=""></a></div>
				<div class="visual_item"><a href="/mobile/shop/order_list.jsp?menuF=1&menuS=1&eatCoun="><img src="/mobile/common/images/m_main_visual4.jpg" alt=""></a></div>
				<!-- <div class="visual_item"><a href="/mobile/shop/order_list.jsp?menuF=4&menuS=2"><img src="/mobile/common/images/m_main_visual5.jpg" alt=""></a></div> -->
			</div>
		...
		<div class="row">
			<div class="notice_ticker">
				...
				<%
					...
					if(noticeCnt > 0){
						...
						%>
						<p><a href="/mobile/customer/notice.jsp?id=<%=footerNoticeId%>" title="<%=footerTitle%>"><%=footerTitle%></a></p>
						<%
					}
				%>
			...
			<div class="banner_main">
				<ul>
					...
					<li><a href="/mobile/shop/mypage/myqna.jsp">
...
<%
query		= "SELECT \n";
query		+= "		(SELECT SALE_TYPE FROM ESL_SALE ES LEFT JOIN ESL_SALE_GOODS ESG ON ES.ID = ESG.SALE_ID WHERE DATE_FORMAT(SYSDATE( ) , '%Y-%m-%d') BETWEEN STDATE AND LTDATE AND (GROUP_CODE = EGG.GROUP_CODE  OR GROUP_CODE IS NULL) ORDER BY ES.ID DESC LIMIT 0, 1) AS ATYPE, \n";
query		+= "		(SELECT SALE_PRICE FROM ESL_SALE ES LEFT JOIN ESL_SALE_GOODS ESG ON ES.ID = ESG.SALE_ID WHERE DATE_FORMAT(SYSDATE( ) , '%Y-%m-%d') BETWEEN STDATE AND LTDATE AND (GROUP_CODE = EGG.GROUP_CODE  OR GROUP_CODE IS NULL) ORDER BY ES.ID DESC LIMIT 0, 1) AS BTYPE, \n";
...
%>
		...
		<div class="row">
			<h2 class="title">잇슬림 다이어트 프로그램</h2>
			<div class="cont1">
				<ul class="item_list">
<%
query		= "SELECT \n";
...
%>
		...
		<div class="row">
			...
			query		+= " FROM ESL_SYSTEM_HOLIDAY WHERE DATE_FORMAT(HOLIDAY, '%Y') =  '"+ year  + "' AND DATE_FORMAT(HOLIDAY, '%m') =  '"+  month  + "' AND DATE_FORMAT(HOLIDAY, '%m') =  '"+ day+"' AND HOLIDAY_TYPE = '02' ";
		...
		<div class="row">
			...
			<div class="cont1">
				<ul class="bs_list">
					<li><a href="/mobile/intro/lowgldiet.jsp" title="why 잇슬림"><img src="/mobile/common/images/common/m_bs1.jpg" alt="" /></a></li>
