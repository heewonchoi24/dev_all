...
if (mode.equals("getList")) {
	...
	if (intTotalCnt > 0) {
		...
		while (rs.next()) {
			...
			data		+= "<diet>"+ pressId +"|<![CDATA["+ title +"]]>|<![CDATA["+ imgUrl +"]]>|<![CDATA["+ ut.cutString(60, content, "..") +"]]>|<![CDATA["+ hitCnt +"]]>|<![CDATA["+ pressUrl +"]]>|<![CDATA["+ instDate.substring(2,10) +"]]>|"+ rs.getInt("re_cnt") +"|"+ nextPage +"</diet>";
		}
	}
