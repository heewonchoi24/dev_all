...
<div id="wrap">
	...
	<!--
           ...
           <div class="grid-navi">
            <table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					...
					<td><a href="/mobile/shop/dietMeal-alacarteA.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner1"><span class="ui-btn-text">알라까르떼<br />슬림</span></span><span class="active"></span></a></td>
                    <td><a href="/mobile/shop/dietMeal-alacarteB.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner1"><span class="ui-btn-text">알라까르떼<br />헬씨</span></span></a></td>  
				</tr>
			</table>
           </div>
           <div class="row">
           <div class="bg-gray font-brown">
               <p>샐러드 형태로 언제 어디서나 간편하게 먹을 수 있는 <strong>"알라까르떼 슬림"</strong>(총 10종 메뉴) </p>
               <div style="margin:10px 0 5px 0;"><img src="/mobile/images/img_top_goods03.jpg" width="100%" alt="" /></div>
         ...
         <div class="divider"></div>
                  <div class="memo">
                      ...
                      <ul>
                          ...
                          <li class="memo02">데우지 않고 간편하게 언제 어디서나 섭취 가능</li>
           ...
           <div class="row">
			   ...
			   * 알라까르떼 슬림은 포크가 함께 제공됩니다.
               ...
               <ul class="ui-listview">
					...
					query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG,PORTION_SIZE FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 9 AND GS.USE_YN = 'Y' ORDER BY GS.ID";
		...
		<div class="row">
              ...
              <p class="f14">평균 260kcal, 식상한 닭가슴살 샐러드는 이제 그만~ 언제 어디서나 가볍게 즐기실 수 있는 10가지의 신선하고 맛있는 저칼로리 샐러드 !</p>
              <div class="divider"></div>
