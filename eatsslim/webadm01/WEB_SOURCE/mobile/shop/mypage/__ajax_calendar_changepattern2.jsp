...
<div id="changeDateCal">
    <div class="inner">
        <header class="pop_header"><h1>배송요일 변경 (2/2)</h1></header>
...
<%--                 <button type="button" class="btn btn_white square half back" onclick="calendarPop.addCont({url : '__ajax_calendar_changepattern.jsp?orderNum=<%=orderNum%>&goodsId=<%=subNum%>&groupCode=<%=gubunCode%>&goods=<%=goods%>', direc : 'prev'})">뒤로가기</button> --%>
