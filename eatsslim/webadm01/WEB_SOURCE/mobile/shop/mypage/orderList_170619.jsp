...
<div id="wrap">
	...
	<div id="content" class="oldClass">
			...
			<li>
				...
				if (Integer.parseInt(orderState) < 2) {
					if (i > 0) {
						if (diffDays > 1) {
				%>
				<a href="orderCancel.jsp?ono=<%=orderNum%>" class="ui-btn ui-mini ui-btn-inline ui-btn-up-c"><span class="ui-btn-inner"><span class="ui-btn-text">주문취소</span></span></a>
				<%
						}
					} else {
						if (diffDays > 2) {
		...
		<ul class="guide">
			<li>* 자세한 주문 조회 및 변경, 배송지 변경은 PC 또는 고객기쁨센터(080-800-0434) 진행 가능합니다.<br /> 또는 잇슬림 옐로우 아이디를 통해 편리하게 이용 가능합니다. 카카오톡에서 '풀무원 잇슬림'을 친구 추가해주세요. </li>
			<li class="font-orange"><a href="http://plus.kakao.com/home/oamlw65x">[친구 추가 바로가기 클릭]</a></li>
		</ul>
	</div>
	<!-- End Content -->
	<div class="ui-footer">
