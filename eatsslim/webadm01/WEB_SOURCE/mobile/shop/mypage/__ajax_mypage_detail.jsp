...
query		+= "	G.GUBUN1, G.GUBUN2, G.GROUP_NAME, G.GROUP_CODE, G.CART_IMG, OG.COUPON_PRICE, G.GROUP_CODE, O.PAY_TYPE, AGENCY_NAME, TELNO, HPNO";
query		+= " FROM ESL_ORDER_GOODS OG, ESL_GOODS_GROUP G, ESL_ORDER O LEFT JOIN";
...
query		+= "     LIMIT 1 ) EOD ";
query		+= "	ON O.ORDER_NUM = EOD.ORDER_NUM ";
...
<div class="content" id="orderDetail">
	<div class="table_style_1 box">
		...
		<% if(!promotion.equals("01") && devlType.equals("0001")){ //-- 일배 상품만 %>
