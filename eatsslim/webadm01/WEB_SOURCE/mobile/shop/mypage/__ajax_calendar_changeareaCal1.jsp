    ...
    <div class="inner">
        ...
        <div class="pop_content">
            ...
            <div class="tip_scheduler">
                <p class="moveText"><span>변경할 일정의 시작일을 선택해주세요.</span></p>
            </div>
...
%>
    ...
    $('#pop_scheduler').datepicker({
        ...
        //	calendarPop.addCont({url : '__ajax_calendar_changearea.jsp', direc : 'up', selectDate : fd, targetInput : '#ca_startDate'});
        	var $this = $(".content.on");
        	var $siblings = $this.siblings(".content");
            ...
            $siblings.find("#ca_startDate_text").val(dateText+" 부터");
            $siblings.find("#ca_startDate").val(fd);
        }
    });
