...
try {
	...
	query		+= " AND GROUP_CODE <> '0300668'"; //-- 장바구니는 노출하지 않는다.
...
if(cnt > 0){
	...
	query		+= "	(SELECT COUNT(*) FROM ESL_ORDER_DEVL_DATE WHERE ORDER_NUM='"+ orderNum +"' AND GOODS_ID = "+ goodsId+" AND DEVL_DATE=A.DEVL_DATE AND GROUP_CODE <> '0300668') DEVL_DATE_CNT, ";
