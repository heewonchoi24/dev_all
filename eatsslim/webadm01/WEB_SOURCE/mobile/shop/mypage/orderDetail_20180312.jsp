...
<div id="wrap" class="expansioncss">
	...
	<div id="container">
		<div class="container_inner">
			...
			%>
											<div class="opt">
												<a href="javascript:void(0);" onclick="window.open('https://www.lotteglogis.com/open/tracking?invno=<%=invNo%>','pop','resizable=no,scrollbars=yes,toolbar=no,location=no,status=no,menubar=no,width=800,height=600')">배송조회</a>
