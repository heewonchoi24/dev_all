...
if (orderNum == null || orderNum.equals("") || outOrderNum == null || outOrderNum.equals("")) {
...
<div id="wrap" class="expansioncss">
	...
	<div id="container">
		<div class="container_inner">
			...
			query		+= " FROM ESL_ORDER WHERE ORDER_NUM = '"+ orderNum +"' AND OUT_ORDER_NUM = '"+ outOrderNum +"'";
			try {
...
<%
			...
			%>
											<div class="opt">
												<a href="javascript:void(0);" onclick="pSlideFn.onAddCont({direction:'next',url:'__ajax_mypage_outmall_calendar.jsp?outordno=<%=outOrderNum%>&ordno=<%=orderNum%>&goodsId=<%=goodsId%>&groupCode=<%=groupCode%>'});">주문조회변경</a>
