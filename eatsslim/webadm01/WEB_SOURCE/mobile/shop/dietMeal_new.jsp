	...
	<div id="content">
		...
		<div class="grid-navi">
			<table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					...
					<td><a href="/mobile/shop/dietMeal-alacarteA.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">신선한<br />알라까르떼</span></span></a></td>
                    <td><a href="/mobile/shop/dietMeal-alacarteB.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">든든한<br />알라까르떼</span></span></a></td>
				</tr>
			</table>
		</div>
		<div class="row">
			<div class="bg-gray font-brown">
				<p>퀴진 한식 STYLE 은 나트륨 Down, 칼로리 Down 건강식단으로 만나보는 Designed Diet Meal입니다.</p>
		...
		<div class="row">
			...
			<ul class="ui-listview">
				...
				query		= "SELECT GS.ID, GS.SET_NAME, GSC.CALORIE, GS.THUMB_IMG,PORTION_SIZE FROM ESL_GOODS_SET GS, ESL_GOODS_SET_CONTENT GSC WHERE GS.ID = GSC.SET_ID AND GS.CATEGORY_ID = 2 ORDER BY GS.ID";
