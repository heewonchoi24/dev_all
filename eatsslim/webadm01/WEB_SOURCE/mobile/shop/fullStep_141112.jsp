	...
	<div id="content" style="margin-top: 135px;">
		...
		<div class="grid-navi">
			<table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					<td><a href="/mobile/shop/secretSlimming.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">6일간의<br />시크릿슬리밍</span></span></a></td>
					...
					<td><a href="/mobile/shop/fullStep.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner"><span class="ui-btn-text">New Full-Step<br />프로그램</span></span></span></a></td>
				</tr>
			</table>
		</div>
