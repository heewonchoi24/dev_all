...
<body>
	<div class="pop-wrap">
	    ...
	    <div class="contentpop">
		   ...
		   <ul class="ordertabs">
				<li>
                <a href="javascript:;" class="defaulttab" rel="tabs1">
            ...
            <div class="tab-content" id="tabs1">
              <div class="eatsslim-popinfo">
                <h2 class="font-brown">01. 식사다이어트만의 특별함</h2> 
               ...
               <div class="divider"></div>
               <h2 class="font-brown">02. 맛있는 다이어트</h2>
                <ul class="dot">
              ...
              <div class="divider"></div>
              <h2 class="font-brown">04. 다양한 메뉴구성</h2>
              <a href="javascript:;" onClick="moveUrl('/mobile/intro/schedule.jsp');"><img class="floatleft" src="/mobile/images/go_schedule.png" width="100%"></a>
              <div class="divider"></div>
             ...
             <div class="tab-content" id="tabs2"> -->
                 <table class="term" width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th width="80">구분</th>
                    <th>내용</th>
                  </tr>
                  ...
                  <tr>
                    <th>제조원 및 생산자</th>
                    <td> 풀무원건강생활(주), 농업회사법인(유)한양제너럴푸드  </td>
                  </tr>
                  <tr>
                    <th>소재지</th>
                    <td>충북 증평군 도안면 원명로 35, 경기도 파주시 소라지로 63-17</td>
                  </tr>
                  <tr>
                    <th>수입품의 경우<br>
                    수입자</th>
                  ...
                  <tr>
                    <th>제조일자</th>
                    <td><p>수령일 기준, 2일전 생산된 제품이 배달됩니다.(알라까르떼 슬림 : 60시간 이내)</p>
                    <p class="font-blue">※ 주문이후 각 생산공장에서 가장 최근에 생산된 제품을 준비하여 신속히 배달되므로, 정확한 제조연월일 안내가 어렵습니다. </p></td>
                  </tr>
                  <tr>
                    <th>유통기한</th>
                    <td>제조시간으로부터 52시간 이내 </td>
                  </tr>
                  <tr>
                    <th>중량 및 구성</th>
                    <td>각 끼니별 150g~600g</td>
                  </tr>
                  <tr>
                    <th>원재료 및 함량</th>
                    <td>각 메뉴별 상세페이지 참조</td>
                  </tr>
                  <tr>
                    <th>유전자 재조합식품<br>
                    여부</th>
                  ...
                  <tr>
                    <th>고객상담실 연락처</th>
                    <td>풀무원 고객기쁨센터<br>
                    080-800-0434(수신자부담)</td>
                  </tr>
	  
                  <tr>
                    <th>유의사항</th>
                    <td><p class="font-blue">잇슬림은 칼로리 조정 식단으로 임산부, 수유부는 섭취하지 마시기 바랍니다.</p></td>
                  </tr>
                </table>
