...
<div id="cboxContent">
	...
	<div class="pop_content" id="couponCheck">
		...
		<div class="coupon_pop_btns">
			<button type="button" class="btn btn_dgray square half" onclick="setCouponPrice();">쿠폰적용</button>
			<button type="button" class="btn btn_white square half" onclick="parent.$.fn.colorbox.close();">취소하기</button>
		</div>
</div>
<!-- End contentpop -->
</div>
