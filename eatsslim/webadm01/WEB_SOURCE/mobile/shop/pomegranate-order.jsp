...
query		= "SELECT ID, GROUP_NAME, GROUP_PRICE, GROUP_INFO, OFFER_NOTICE, GROUP_CODE FROM ESL_GOODS_GROUP WHERE GUBUN1 = '60' AND GUBUN2 = '02' AND  GROUP_CODE = '0070560' ";
...
<div id="wrap">
	<div class="ui-header-fixed" style="overflow:hidden;">
		...
		<ul class="subnavi">
			...
			<li class="current"><a href="/mobile/shop/onion.jsp">건강즙</a></li>
		</ul>
	</div>
	<!-- End ui-header -->
	<!-- Start Content -->
	<form name="frm_order" id="frm_order" method="post">
		...
		<div id="content">
			<h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">석류세트 제품구매 (로그인 필수)</span></span></h1>
