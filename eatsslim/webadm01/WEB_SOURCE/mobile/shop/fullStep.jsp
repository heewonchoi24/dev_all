...
<div id="wrap">
	<div class="ui-header-fixed" style="overflow: hidden;">
		...
		<ul class="subnavi">
			...
			<li class="current"><a href="/mobile/shop/weight2weeks.jsp">프로그램</a></li>
	...
	<!--
		...
		<div class="grid-navi">
			<table class="navi" cellspacing="10" cellpadding="0">
				<tr>
					...
					<td><a href="/mobile/shop/fullStep.jsp" class="ui-btn ui-btn-inline ui-btn-up-a"><span class="ui-btn-inner"><span class="ui-btn-text">감량유지<br />4주</span></span><span class="active"></span></a></td>
				</tr>
				<tr>
		    		<td><a href="/mobile/shop/cleanseProgram.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">클렌즈<br />프로그램</span></span></a></td>
					<td><a href="/mobile/shop/smartgram.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">잇슬림<br />스마트그램</span></span></a></td>
					<td><a href="/mobile/shop/speed4weeks.jsp" class="ui-btn ui-btn-inline ui-btn-up-a-line"><span class="ui-btn-inner"><span class="ui-btn-text">스피드<br />4주</span></span></a></td>
				</tr>
			</table>
		</div>
		<div class="row">
			<div class="bg-gray">
				<p>급격한 식사조절이 아닌 준비된 식사조절로, 감량부터 유지를 함께 원하는 고객을 위한 <strong>"감량&유지 4주 프로그램"</strong></p>
		...
		<div class="grid-navi">
			<table class="navi" border="0" cellspacing="10" cellpadding="0">
				<tr>
					<td><a href="/mobile/shop/popup/program_term.jsp" class="ui-btn ui-btn-inline ui-btn-up-d iframe"><span class="ui-btn-inner"><span class="ui-btn-text">상품정보</span></span></a></td>
					<td><a href="/mobile/shop/dietProgram-order.jsp" class="ui-btn ui-btn-inline ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">감량&유지 4주 프로그램 구매</span></span></a></td>
				</tr>
			</table>
		</div>
			</div>
