...
<div id="wrap">
	<div class="ui-header-fixed" style="overflow:hidden;">
		...
		<ul class="subnavi">
			...
			<li><a href="/mobile/shop/weight2weeks.jsp">프로그램</a></li>
			<li class="current"><a href="/mobile/shop/minimeal.jsp">간편식</a></li>
	...
	<form name="frm_order" id="frm_order" method="post">
		...
		<input type="hidden" name="devl_day" id="devl_day" value="5" />
		...
		<div id="content">
			<h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">시크릿수프 제품구매 (로그인 필수)</span></span></h1>
			<div class="row bg-gray">
				<ul class="itembox">
					<li>
						<h3>배송가능지역 확인</h3>
						<p>배송가능 지역인지 확인해 주세요.</p>
						<a href="javascript:;" onclick="window.open('/mobile/shop/popup/AddressSearchJiPop.jsp?ztype=0003', 'AddressPop', 'scrollbars=yes,resizable=yes,width=100%,height=auto');" class="ui-btn ui-mini ui-btn-inline ui-btn-up-c"><span class="ui-btn-inner"><span class="ui-btn-text">검색</span></span></a>
					</li>
					<li>
						<h3>배송스타일 선택</h3>
						<ul class="form-line">
							<li>
								<div class="select-box">
									<select name="ss_type" id="ss_type">
										<option value="0">매일(월~금)-총10개/주</option>
