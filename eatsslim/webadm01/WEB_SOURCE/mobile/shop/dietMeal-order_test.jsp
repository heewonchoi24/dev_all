			...
			<div class="row bg-gray">
				<ul class="itembox">
					...
					<li id="addOption">
						...
						<ul class="form-line">
							<li>
								<div class="select-box" id="optionSelect">
								...
								<font style="font-weight:bold; color:red;">옵션상품 20% 할인중(7/18~31)</font>
								<div class="clear"></div>
							</li>
						</ul>
					</li>
...
function addCart(t) {
	$("#cart_type").val(t);
	$.post("dietMeal_ajax_test.jsp", $("#frm_order").serialize(),
	function(data) {
		$(data).find("result").each(function() {
			if ($(this).text() == "success") {
				if (t == 'C') {
...
function getSalePrice() {
	...
	if (addPrice > 0) {
		...
		if (saleType == "W") {
			...
			if ($("#devl_week").val() == 2) {
				salePrice	= totalPrice - 5000;
			} else if ($("#devl_week").val() == 4) {
				salePrice	= totalPrice - 10000;
			} else {
