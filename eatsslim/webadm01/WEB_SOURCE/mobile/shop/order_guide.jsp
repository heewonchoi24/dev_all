...
<div id="wrap">
    ...
    <!-- Start Content -->
    <div id="content">
        <h1 class="ui-bar-a"><span class="ui-btn-inner"><span class="ui-btn-text">나에게 맞는 잇슬림</span></span></h1>
				...
				<ul class="accordion">
							...
							<div class="inner">
								...
								<ul class="prd_list">
									<li>
										...
										<div class="info">
											<p class="title">400 슬림식(총 22종 메뉴)</p>
											<p class="dec">과학적인 영양 설계로 디자인한 칼로리 조절 식사</p>
											<div class="btns">
									...
									<li>
										...
										<div class="info">
											...
											<p class="dec">신선한 채소에 토핑을 곁들여 포만감도 느낄 수 있는 요리형 샐러드</p>
											<div class="btns">
									...
									<li>
										<div class="photo"><img src="/images/order_guide_img_1_5.jpg"><div class="cal_info"><p>200Kcal 내외</p></div></div>
										<div class="info">
											<p class="title">200 스팀샐러드(총 5종 메뉴)</p>
											<p class="dec">채소와 곡류의 영양 흡수율을 높인 스팀 샐러드밀</p>
											<div class="btns">
												<a href="/mobile/shop/order_view.jsp?cateCode=0&cartId=105&paramType=list">자세히보기</a>
												<a href="/mobile/shop/order_list.jsp?menuF=1&menuS=5&eatCoun=">바로구매</a>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="photo"><img src="/images/order_guide_img_1_4.jpg"><!-- <img src="/mobile/common/images/guide/order_guide_detail_1.jpg"> --> <div class="cal_info"><p>270Kcal 내외</p></div></div>
										<div class="info">
											<p class="title">미니밀(총 12종 메뉴)</p>
											<p class="dec">건강잡곡밥과 슈퍼푸드로 칼로리 조절과 영양을 더한 간편한 미니 컵밥</p>
											<div class="btns">
												<a href="/mobile/shop/order_list.jsp?menuF=1&menuS=4&eatCoun=">자세히보기</a>
												<a href="/mobile/shop/order_view.jsp?cateCode=0&cartId=110&paramType=list">바로구매</a>
											</div>
										</div>
									</li>
								</ul>
					...
					<li class="accordion2">
						...
						<div class="acc_content">
							<div class="inner">
								<div class="acc_contentTop">
									<p>목표 섭취 칼로리에 따라 잇슬림에서 제안하는 칼로리 조절 전문 프로그램(1일 2식 또는 3식 제공)</p>
									<ul class="col4">
										<li>
								...
								<ul class="prd_list">
									<li>
										<div class="photo"><img src="/images/order_guide_img_2_1.jpg"><!-- <img src="/mobile/common/images/guide/order_guide_detail_2.jpg"> --> <div class="cal_info"><p>800Kcal(1일) 내외</p></div></div>
										<div class="info">
											<p class="title">단기 프로그램(3일)</p>
											<p class="dec">단기간에 칼로리 조절을 목적으로 하는 분들을 위한 3일 구성의 단기 체험 프로그램</p>
											<div class="btns">
												<!--<a href="/mobile/shop/order_list.jsp?menuF=2&menuS=1">자세히보기</a> -->
												<a href="/mobile/shop/order_view.jsp?cateCode=0&cartId=73&paramType=list">자세히보기</a>
											</div>
										</div>
									</li>
									<li>
										...
										<div class="info">
											<p class="title">칼로리 조절 프로그램(2/4주)</p>
											<p class="dec">목적별, 기간별로 최적화된 영양 설계를 바탕으로 한 잇슬림의 대표 칼로리 조절 프로그램</p>
											<div class="btns">
												<a href="/mobile/shop/order_list.jsp?menuF=2&menuS=2">자세히보기</a>
												<a href="/mobile/shop/order_view.jsp?cateCode=0&cartId=65&paramType=list">바로구매</a>
											</div>
										</div>
									</li>
									<li>
										<div class="photo"><img src="/images/order_guide_img_2_3.jpg"><div class="cal_info"><p>900Kcal(1일) 내외</p></div></div>
										<div class="info">
											<p class="title">클렌즈 프로그램(1/2/4주)</p>
											<p class="dec">1일동안 클렌즈랩을 통한 건강한 체내 비움 이후, 잇슬림 식단으로 칼로리 조절을 제안하는 프로그램</p>
											<div class="btns">
