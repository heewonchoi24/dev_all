...
<div id="wrap">
  ...
  <div id="content" class="oldClass">
      ...
      <table class="navi" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td><a href="/mobile/intro/orderForm.jsp" class="ui-btn ui-btn-inline ui-btn-up-f-line"><span class="ui-btn-inner"><span class="ui-btn-text">주문하기<br />
            쿠폰적용</span></span></a></td>
          <td><a href="/mobile/intro/changeOrder.jsp" class="ui-btn ui-btn-inline ui-btn-up-f"><span class="ui-btn-inner"><span class="ui-btn-text">주문변경<br />
            Type1</span></span><span class="active"></span></a></td>
	...
	<div><img src="/mobile/images/step04.jpg" alt="배달지역확인"></div>
