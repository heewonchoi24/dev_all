    ...
    <div class="grid-navi eatsstory">
      <table class="navi" cellspacing="10" cellpadding="0">
        <tr>
          ...
          <td><a href="/mobile/intro/changeOrderKakao.jsp" class="ui-btn ui-btn-inline ui-btn-up-f"><span class="ui-btn-inner"><span class="ui-btn-text">주문변경<br />
            Type2</span></span><span class="active"></span></a></td>
        </tr>
      </table>
    </div>
    <div class="row">

	<div><img src="/mobile/images/step05.jpg" alt="배달지역확인"></div>
