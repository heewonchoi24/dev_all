  ...
  <div id="content" class="oldClass">
    ...
    <div class="grid-navi eatsstory">
      <table class="navi" cellspacing="10" cellpadding="0">
        <tr>
          <td><a href="/mobile/intro/checkLocation.jsp" class="ui-btn ui-btn-inline ui-btn-up-f"><span class="ui-btn-inner"><span class="ui-btn-text">배달지역<br />
            확인</span></span><span class="active"></span></a></td>
	...
	<div><img src="/mobile/images/step01.jpg" alt="배달지역확인"></div>
