	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="location">
				...
				<p id="path"><img src="../images/common/layout/ico_home.gif" alt="홈" /> &gt; 상품관리&gt; 세트그룹관리 &gt; <strong>기능식품</strong></p>
			</div>
			<!-- //location -->
			<!-- contents -->
			<div id="contents">
				<form name="frm_write" id="frm_write" method="post" action="goods_group_fvt_db.jsp" enctype="multipart/form-data">
					<input type="hidden" name="mode" value="upd" />
					<input type="hidden" name="id" value="<%=groupId%>" />
					<input type="hidden" name="param" value="<%=param%>" />
					<input type="hidden" name="gubun1" value="05" />
							...
							<tr>
								...
								<td class="td_edit">
									<select name="gubun2" id="gubun2">
										...
										<%if (gubun2.equals("01")) {%>
										<option value="01" selected="selected">유산균</option>
										<%} else if (gubun2.equals("02")) {%>
										<option value="02" selected="selected">비타민</option>
										<%} else if (gubun2.equals("03")) {%>
										<option value="03" selected="selected">식사대용</option>
										<%} else if (gubun2.equals("04")) {%>
										<option value="04" selected="selected">기타</option>
										<%}%>
									</select>
								</td>
