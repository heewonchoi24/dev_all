								...
								<td class="">
									<ul class="rec_prd_list">
										<li id="rec_prd_1">
											...
											<div class="btns">
												<a href="javascript:void(0);"  onclick="delRecPrd(1);">삭제 X</a>
											</div>
										</li>
										<li id="rec_prd_2">
											...
											<div class="title"></div>
											<div class="btns">
												<a href="javascript:void(0);" onclick="searchRecPrd(2);">검색</a>
											</div>
										</li>
										<li id="rec_prd_3">
											...
											<div class="title"></div>
											<div class="btns">
												<a href="javascript:void(0);" onclick="searchRecPrd(3);">검색</a>
											</div>
										</li>
										<li id="rec_prd_4">
											...
											<div class="title"></div>
											<div class="btns">
												<a href="javascript:void(0);" onclick="searchRecPrd(4);">검색</a>
											</div>
										</li>
									</ul>
								</td>
...
%>
					...
					<div class="btn_center">
						<a href="javascript:;" onclick="setContent('group_info');chkForm(document.frm_edit)" id="save_btn"  class="function_btn"><span>저장</span></a>
...
function searchPrd() {
	...
	if(text == ""){
		...
		for (var i = 0; i < 5; i++) {
			...
			result +=			'<div class="title">헬씨퀴진+알라까르떼 슬림</div>';
			result +=			'<p>1일 1식</p>';
	        result +=		'</a>';
	        result +=	'</li>';
       	}
