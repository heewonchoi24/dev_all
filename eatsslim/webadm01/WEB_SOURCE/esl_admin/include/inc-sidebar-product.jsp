		...
		<div id="sidebar">
			...
			<ul id="lnb">
				...
				<li>
					...
					<ul>
						<li><a href="goods_group_list.jsp?sch_gubun1=01">식사다이어트</a></li>
						<li><a href="goods_group_list.jsp?sch_gubun1=02">프로그램다이어트</a></li>
						<li><a href="goods_group_list.jsp?sch_gubun1=03">타입별다이어트</a></li>
						<li><a href="goods_group_list.jsp?sch_gubun1=50">기능식품</a></li>
						<li><a href="goods_group_list.jsp?sch_gubun1=60">건강즙</a></li>
					</ul>
				</li>
				<li><a href="category_schedule.jsp">식단관리</a></li>
				<li><a href="holiday_list.jsp">휴무일관리</a></li>
				<li><a href="ch_list.jsp">채널관리</a></li>
			</ul>
			<!-- //lnb -->
			<%}else{
