			...
			<div id="contents">
				<form name="frm_write" id="frm_write" method="post" action="faq_db.jsp">
							...
							<tr>
								...
								<td>
									<select name="faq_type" id="faq_type" required label="구분">
										...
										<option value="01">교환/환불</option>
										<option value="02">회원관련</option>
										<option value="03">주문/결제</option>
										<option value="04">배송관련</option>
					...
					<div class="btn_center">
						...
						<a href="faq_list.jsp" class="function_btn"><span>목록</span></a>
					</div>
				</form>
			</div>
			<!-- //contents -->
