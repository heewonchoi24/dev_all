...
param		= "&amp;page="+ iPage +"&pgsize="+ pgsize +"&field="+ field +"&keyword="+ keyword+"&p_gubun="+p_gubun+"&id="+pressId;
...
if (mode != null) {
	if (mode.equals("write")) {
		...
		out.print("<script>alert('등록되었습니다');location.href='po_edit.jsp?"+param+"';</script>");
		...
		out.print("<script>alert('삭제되었습니다');location.href='po_edit.jsp?"+param+"';</script>");
