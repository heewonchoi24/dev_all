...
query		= "SELECT ID, TITLE, OPEN_YN, LINK, STDATE, LTDATE, DATE_FORMAT(INST_DATE, '%Y.%m.%d') WDATE";
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<div id="contents">
				...
				<form name="frm_list" id="frm_list" method="post" action="popup_db.jsp">
					...
					<table class="table02" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<th scope="col"><span>링크주소</span></th>
								<th scope="col"><span>팝업기간</span></th>
							...
							%>
							<tr>
								<td><input type="checkbox" class="selectable" value="<%=popupId%>" /></td>
								<td><%=curNum%></td>
								...
								<td><%=openYn%></td>
								<td>
									<a href="popup_edit.jsp?id=<%=popupId + param%>" class="function_btn"><span>수정</span></a>
								</td>
							</tr>
							<%
									curNum--;
				...
				<div class="btn_style1">
					...
					<p class="right_btn">
						<a href="popup_write.jsp" class="function_btn"><span>등록</span></a>
					</p>
				</div>
