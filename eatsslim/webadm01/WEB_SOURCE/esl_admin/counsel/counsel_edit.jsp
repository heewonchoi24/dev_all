					...
					<table class="tableView" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<textarea id="answer" name="answer" style="height:500px;width:100%;" type=editor>
									<%
										if (answer.equals("") || answer == null) {
												out.print("안녕하세요. 고객님.<br>건강하고 맛있는 다이어트, 풀무원 잇슬림입니다.<br><br><br>");
												out.print("감사합니다.<br>풀무원 잇슬림 담당자 드림.");
										} else {
											out.print(answer);
										}										
									%>
