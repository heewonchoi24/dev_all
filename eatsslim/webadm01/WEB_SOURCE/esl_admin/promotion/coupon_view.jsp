...
param		= "page="+ iPage +"&pgsize="+ pgsize +"&sch_ctype="+ schCtype +"&sch_stdate="+ schStdate +"&sch_ltdate="+ schLtdate +"&sch_vendor="+ schVendor;
...
if (request.getParameter("id") != null && request.getParameter("id").length() > 0) {
	...
	query		+= "	DATE_FORMAT(STDATE, '%Y.%m.%d') STDATE, DATE_FORMAT(LTDATE, '%Y.%m.%d') LTDATE, VENDOR";
				...
				<table class="table01" border="1" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=ut.getCouponType(ctype)%>/<%=ut.getVendor(vendor)%></td>
							<th scope="row">
								<span>사용기간</span>
							</th>
							<td><%=stdate+"~"+ltdate%></td>
