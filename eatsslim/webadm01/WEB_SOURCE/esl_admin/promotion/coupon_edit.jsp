...
if (request.getParameter("id") != null && request.getParameter("id").length() > 0) {
	...
	query		= "SELECT COUPON_NAME, COUPON_TYPE, STDATE, LTDATE, VENDOR, SALE_TYPE, SALE_PRICE, SALE_USE_YN, USE_LIMIT_CNT, USE_LIMIT_PRICE, USE_GOODS, MAX_COUPON_CNT, RAND_NUM_TYPE";
					...
					<table class="tableView" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" name="coupon_name" id="coupon_name" class="input1" style="width:300px;" maxlength="100" value="<%=couponName%>" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									...
									상품판매가격의
									<input type="text" name="sale_price1" id="sale_price1" value="<%if (saleType.equals("P")) {out.println(salePrice);} else {out.println("0");}%>" class="input1" style="width:60px;" maxlength="3" dir="rtl" onblur="this.value=this.value.replace(/[^0-9]/g,'');" />
									% 할인
									<input type="radio" name="sale_type" value="W" <%if (saleType.equals("W")) out.println(" checked=\"checked\"");%> />
									상품판매가격의
									<input type="text" name="sale_price2" id="sale_price2" value="<%if (saleType.equals("W")) {out.println(salePrice);} else {out.println("0");}%>" class="input1" style="width:60px;" maxlength="7" dir="rtl" onkeyup="onlyNum(this);" />
									원 할인
								</td>
							</tr>
							<!--tr>
							...
							<tr>
								...
								<td colspan="3">
									구매최소수량
									<input type="text" name="use_limit_cnt" id="use_limit_cnt" class="input1" style="width:60px;" maxlength="2" dir="rtl" value="<%=useLimitCnt%>" onkeyup="onlyNum(this);" />
									개 /
									상품판매가격의
									<input type="text" name="use_limit_price" id="use_limit_price" class="input1" style="width:60px;" maxlength="7" dir="rtl" value="<%=useLimitPrice%>" onkeyup="onlyNum(this);" />
									원 이상
								</td>
							</tr>
							<tr>
										...
										<p class="mt_5">
											<div style="overflow:auto;height:200px;">
												<table cellspacing="0" class="table01" style="width:500px;">
													...
													%>
													<tr>
														<td><input type="checkbox" name="group_code" value="<%=rs.getString("GROUP_CODE")+","+rs.getString("GROUP_NAME")%>" 
															<%
