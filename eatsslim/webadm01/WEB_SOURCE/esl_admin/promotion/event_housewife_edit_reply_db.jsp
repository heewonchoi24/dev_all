...
if (mode != null) {
	...
	if (mode.equals("write")) {
		...
		out.print("<script>alert('등록되었습니다');location.href='event_housewife_edit.jsp?"+param+"';</script>");
		...
		out.print("<script>alert('삭제되었습니다');location.href='event_housewife_edit.jsp?"+param+"';</script>");
