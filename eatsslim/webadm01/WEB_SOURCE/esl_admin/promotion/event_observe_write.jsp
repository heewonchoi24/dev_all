...
<div id="wrap">
	...
	<div id="container" class="group">
		...
		<div id="incon">
			...
			<!-- contents -->
			<div id="contents">
				<form name="frm_write" id="frm_write" method="post" action="event_observe_db.jsp" enctype="multipart/form-data">
					...
					<div class="btn_center">
						...
						<a href="event_observe.jsp" class="function_btn"><span>목록</span></a>
					</div>
				</form>
			</div>
			<!-- //contents -->
