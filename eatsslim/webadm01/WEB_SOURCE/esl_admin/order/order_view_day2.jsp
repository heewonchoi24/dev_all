	...
	<div class="popup_wrap">
		...
		<!-------------------------------------->
			<div class="tab_layout" style="display:block;" id="tablmenu1">
					...
					<table class="table02 mt_5" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td><%=ut.getDevlState(rs.getString("STATE"))%></td>
				...
				<br />
				<form name="frm_gift" id="frm_gift"  action="order_view_day_ajax2.jsp">
					...
					<table class="table01 mt_5" border="1" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<td class="td01">
									<input type="text" class="input1" name="zipcode" id="zipcode" maxlength="7" style="width:60px" onkeyup="this.value=this.value.replace(/[^0-9-]/g,'');" value="" readonly="readonly" />
									<a href="javascript:;" onclick="window.open('../include/inc-popup-zipcode.jsp','popup','width=450,height=370,resizable=no,scrollbars=yes');" class="function_btn"><span>우편번호 검색</span></a>
									<p class="mt_5">
										<input type="text" class="input1" name="addr1" id="addr1" style="width:70%;" maxlength="150" value=""  required label="배송지 주소" readonly="readonly" />
