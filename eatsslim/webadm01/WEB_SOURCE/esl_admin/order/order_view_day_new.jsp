...
if (rs.next()) {
	...
	query1		= "SELECT EODD.AGENCYID, EODA.AGENCY_NAME FROM ESL_ORDER_DEVL_DATE EODD LEFT JOIN ESL_ORDER_DEVL_AGENCY EODA ON EODD.AGENCYID = EODA.AGENCY_ID ";
					...
					<table class="table01 mt_5" border="1" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<td class="td01">
									<input type="text" name="stdate_agcy" class="date-address" style="width:90px;" readonly="readonly" value="2016-05-02"/>
...
function editAgency() {
	$.post("order_view_day_ajax_new.jsp", $("#frm_agency").serialize(),
	function(data) {
		$(data).find("result").each(function() {
			if ($(this).text() == "success") {
				alert("정상적으로 처리되었습니다.");
