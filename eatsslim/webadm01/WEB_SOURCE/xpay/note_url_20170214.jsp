...
String query		= "";
	...
	*/
    ...
    if (LGD_MID.equals("kvp_eatsslim") || LGD_HASHDATA2.trim().equals(LGD_HASHDATA)) { //해쉬값 검증이 성공이면
        if (LGD_RESPCODE.trim().equals("0000")){ //결제가 성공이면
             ...
             */    
			 ...
			 query="UPDATE ESL_ORDER SET PAY_DATE=NOW(),ORDER_STATE='01',PAY_YN='Y', PG_TID = '"+ LGD_TID +"' WHERE ORDER_NUM='"+LGD_OID+"'";
...
<%
         ...
         */      
        resultMSG = "alert('결제결과 상점 DB처리(NOTE_URL) 해쉬값 검증이 실패하였습니다.');";  
